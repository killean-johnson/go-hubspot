...
// checks if the PeriodToMonths type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PeriodToMonths{}

// PeriodToMonths struct for PeriodToMonths
...
type _PeriodToMonths PeriodToMonths
...
func NewPeriodToMonthsWithDefaults() *PeriodToMonths {
	this := PeriodToMonths{}
	var operator string = "PERIOD_TO_MONTHS"
	this.Operator = operator
	return &this
}
...
func (o PeriodToMonths) MarshalJSON() ([]byte, error) {
...
func (o PeriodToMonths) ToMap() (map[string]interface{}, error) {
...
func (o *PeriodToMonths) UnmarshalJSON(data []byte) (err error) {
	...
	varPeriodToMonths := _PeriodToMonths{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPeriodToMonths)

	if err != nil {
		return err
	}

	*o = PeriodToMonths(varPeriodToMonths)

	return err
}

type NullablePeriodToMonths struct {
	value *PeriodToMonths
	isSet bool
}

func (v NullablePeriodToMonths) Get() *PeriodToMonths {
	return v.value
}

func (v *NullablePeriodToMonths) Set(val *PeriodToMonths) {
	v.value = val
	v.isSet = true
}

func (v NullablePeriodToMonths) IsSet() bool {
	return v.isSet
}

func (v *NullablePeriodToMonths) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePeriodToMonths(val *PeriodToMonths) *NullablePeriodToMonths {
	return &NullablePeriodToMonths{value: val, isSet: true}
}

func (v NullablePeriodToMonths) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePeriodToMonths) UnmarshalJSON(src []byte) error {
	v.isSet = true
