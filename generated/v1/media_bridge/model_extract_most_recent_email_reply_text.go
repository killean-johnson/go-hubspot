...
// checks if the ExtractMostRecentEmailReplyText type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtractMostRecentEmailReplyText{}

// ExtractMostRecentEmailReplyText struct for ExtractMostRecentEmailReplyText
...
type _ExtractMostRecentEmailReplyText ExtractMostRecentEmailReplyText
...
func NewExtractMostRecentEmailReplyText(operator string) *ExtractMostRecentEmailReplyText {
	this := ExtractMostRecentEmailReplyText{}
...
func NewExtractMostRecentEmailReplyTextWithDefaults() *ExtractMostRecentEmailReplyText {
	this := ExtractMostRecentEmailReplyText{}
	var operator string = "EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT"
	this.Operator = operator
	return &this
}
...
func (o ExtractMostRecentEmailReplyText) MarshalJSON() ([]byte, error) {
...
func (o ExtractMostRecentEmailReplyText) ToMap() (map[string]interface{}, error) {
...
func (o *ExtractMostRecentEmailReplyText) UnmarshalJSON(data []byte) (err error) {
	...
	varExtractMostRecentEmailReplyText := _ExtractMostRecentEmailReplyText{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExtractMostRecentEmailReplyText)

	if err != nil {
		return err
	}

	*o = ExtractMostRecentEmailReplyText(varExtractMostRecentEmailReplyText)

	return err
}

type NullableExtractMostRecentEmailReplyText struct {
	value *ExtractMostRecentEmailReplyText
	isSet bool
}

func (v NullableExtractMostRecentEmailReplyText) Get() *ExtractMostRecentEmailReplyText {
	return v.value
}

func (v *NullableExtractMostRecentEmailReplyText) Set(val *ExtractMostRecentEmailReplyText) {
	v.value = val
	v.isSet = true
}

func (v NullableExtractMostRecentEmailReplyText) IsSet() bool {
	return v.isSet
}

func (v *NullableExtractMostRecentEmailReplyText) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtractMostRecentEmailReplyText(val *ExtractMostRecentEmailReplyText) *NullableExtractMostRecentEmailReplyText {
	return &NullableExtractMostRecentEmailReplyText{value: val, isSet: true}
}

func (v NullableExtractMostRecentEmailReplyText) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtractMostRecentEmailReplyText) UnmarshalJSON(src []byte) error {
	v.isSet = true
