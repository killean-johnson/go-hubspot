...
// ObjectTypeDefinitionPatch struct for ObjectTypeDefinitionPatch
...
type _ObjectTypeDefinitionPatch ObjectTypeDefinitionPatch
...
// GetClearDescription returns the ClearDescription field value
...
// GetClearDescriptionOk returns a tuple with the ClearDescription field value
// and a boolean to check if the value has been set.
...
// SetClearDescription sets field value
...
func (o *ObjectTypeDefinitionPatch) UnmarshalJSON(data []byte) (err error) {
	...
	varObjectTypeDefinitionPatch := _ObjectTypeDefinitionPatch{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varObjectTypeDefinitionPatch)

	if err != nil {
		return err
	}

	*o = ObjectTypeDefinitionPatch(varObjectTypeDefinitionPatch)
