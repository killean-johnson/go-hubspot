...
// checks if the MultiplyNumbers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiplyNumbers{}

// MultiplyNumbers struct for MultiplyNumbers
...
type _MultiplyNumbers MultiplyNumbers
...
func NewMultiplyNumbersWithDefaults() *MultiplyNumbers {
	this := MultiplyNumbers{}
	var operator string = "MULTIPLY_NUMBERS"
	this.Operator = operator
	return &this
}
...
func (o MultiplyNumbers) MarshalJSON() ([]byte, error) {
...
func (o MultiplyNumbers) ToMap() (map[string]interface{}, error) {
...
func (o *MultiplyNumbers) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiplyNumbers := _MultiplyNumbers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultiplyNumbers)

	if err != nil {
		return err
	}

	*o = MultiplyNumbers(varMultiplyNumbers)

	return err
}

type NullableMultiplyNumbers struct {
	value *MultiplyNumbers
	isSet bool
}

func (v NullableMultiplyNumbers) Get() *MultiplyNumbers {
	return v.value
}

func (v *NullableMultiplyNumbers) Set(val *MultiplyNumbers) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiplyNumbers) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiplyNumbers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiplyNumbers(val *MultiplyNumbers) *NullableMultiplyNumbers {
	return &NullableMultiplyNumbers{value: val, isSet: true}
}

func (v NullableMultiplyNumbers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiplyNumbers) UnmarshalJSON(src []byte) error {
	v.isSet = true
