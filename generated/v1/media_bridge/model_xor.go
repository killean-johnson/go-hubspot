...
// checks if the Xor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Xor{}
...
func (o Xor) MarshalJSON() ([]byte, error) {
...
func (o Xor) ToMap() (map[string]interface{}, error) {
...
func (o *Xor) UnmarshalJSON(data []byte) (err error) {
...
type NullableXor struct {
	value *Xor
	isSet bool
}

func (v NullableXor) Get() *Xor {
	return v.value
}

func (v *NullableXor) Set(val *Xor) {
	v.value = val
	v.isSet = true
}

func (v NullableXor) IsSet() bool {
	return v.isSet
}

func (v *NullableXor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableXor(val *Xor) *NullableXor {
	return &NullableXor{value: val, isSet: true}
}

func (v NullableXor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableXor) UnmarshalJSON(src []byte) error {
	v.isSet = true
