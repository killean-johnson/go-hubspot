...
// checks if the HasEmailReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HasEmailReply{}

// HasEmailReply struct for HasEmailReply
...
type _HasEmailReply HasEmailReply
...
func NewHasEmailReplyWithDefaults() *HasEmailReply {
	this := HasEmailReply{}
	var operator string = "HAS_EMAIL_REPLY"
	this.Operator = operator
	return &this
}
...
func (o HasEmailReply) MarshalJSON() ([]byte, error) {
...
func (o HasEmailReply) ToMap() (map[string]interface{}, error) {
...
func (o *HasEmailReply) UnmarshalJSON(data []byte) (err error) {
	...
	varHasEmailReply := _HasEmailReply{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHasEmailReply)

	if err != nil {
		return err
	}

	*o = HasEmailReply(varHasEmailReply)

	return err
}

type NullableHasEmailReply struct {
	value *HasEmailReply
	isSet bool
}

func (v NullableHasEmailReply) Get() *HasEmailReply {
	return v.value
}

func (v *NullableHasEmailReply) Set(val *HasEmailReply) {
	v.value = val
	v.isSet = true
}

func (v NullableHasEmailReply) IsSet() bool {
	return v.isSet
}

func (v *NullableHasEmailReply) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHasEmailReply(val *HasEmailReply) *NullableHasEmailReply {
	return &NullableHasEmailReply{value: val, isSet: true}
}

func (v NullableHasEmailReply) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHasEmailReply) UnmarshalJSON(src []byte) error {
	v.isSet = true
