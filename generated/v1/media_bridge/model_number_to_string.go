...
// checks if the NumberToString type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NumberToString{}

// NumberToString struct for NumberToString
...
type _NumberToString NumberToString
...
func NewNumberToStringWithDefaults() *NumberToString {
	this := NumberToString{}
	var operator string = "NUMBER_TO_STRING"
	this.Operator = operator
	return &this
}
...
func (o NumberToString) MarshalJSON() ([]byte, error) {
...
func (o NumberToString) ToMap() (map[string]interface{}, error) {
...
func (o *NumberToString) UnmarshalJSON(data []byte) (err error) {
	...
	varNumberToString := _NumberToString{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNumberToString)

	if err != nil {
		return err
	}

	*o = NumberToString(varNumberToString)

	return err
}

type NullableNumberToString struct {
	value *NumberToString
	isSet bool
}

func (v NullableNumberToString) Get() *NumberToString {
	return v.value
}

func (v *NullableNumberToString) Set(val *NumberToString) {
	v.value = val
	v.isSet = true
}

func (v NullableNumberToString) IsSet() bool {
	return v.isSet
}

func (v *NullableNumberToString) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNumberToString(val *NumberToString) *NullableNumberToString {
	return &NullableNumberToString{value: val, isSet: true}
}

func (v NullableNumberToString) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNumberToString) UnmarshalJSON(src []byte) error {
	v.isSet = true
