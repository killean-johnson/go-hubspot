...
// checks if the IfNumber type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IfNumber{}

// IfNumber struct for IfNumber
...
func (o IfNumber) MarshalJSON() ([]byte, error) {
...
func (o IfNumber) ToMap() (map[string]interface{}, error) {
...
func (o *IfNumber) UnmarshalJSON(data []byte) (err error) {
	...
	varIfNumber := _IfNumber{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIfNumber)

	if err != nil {
		return err
	}

	*o = IfNumber(varIfNumber)

	return err
}

type NullableIfNumber struct {
	value *IfNumber
	isSet bool
}

func (v NullableIfNumber) Get() *IfNumber {
	return v.value
}

func (v *NullableIfNumber) Set(val *IfNumber) {
	v.value = val
	v.isSet = true
}

func (v NullableIfNumber) IsSet() bool {
	return v.isSet
}

func (v *NullableIfNumber) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIfNumber(val *IfNumber) *NullableIfNumber {
	return &NullableIfNumber{value: val, isSet: true}
}

func (v NullableIfNumber) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIfNumber) UnmarshalJSON(src []byte) error {
	v.isSet = true
