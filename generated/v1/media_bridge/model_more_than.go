...
// checks if the MoreThan type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MoreThan{}

// MoreThan struct for MoreThan
...
func (o MoreThan) MarshalJSON() ([]byte, error) {
...
func (o MoreThan) ToMap() (map[string]interface{}, error) {
...
func (o *MoreThan) UnmarshalJSON(data []byte) (err error) {
	...
	varMoreThan := _MoreThan{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMoreThan)

	if err != nil {
		return err
	}

	*o = MoreThan(varMoreThan)

	return err
}

type NullableMoreThan struct {
	value *MoreThan
	isSet bool
}

func (v NullableMoreThan) Get() *MoreThan {
	return v.value
}

func (v *NullableMoreThan) Set(val *MoreThan) {
	v.value = val
	v.isSet = true
}

func (v NullableMoreThan) IsSet() bool {
	return v.isSet
}

func (v *NullableMoreThan) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMoreThan(val *MoreThan) *NullableMoreThan {
	return &NullableMoreThan{value: val, isSet: true}
}

func (v NullableMoreThan) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMoreThan) UnmarshalJSON(src []byte) error {
	v.isSet = true
