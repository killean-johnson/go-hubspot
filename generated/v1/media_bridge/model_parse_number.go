...
// checks if the ParseNumber type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParseNumber{}

// ParseNumber struct for ParseNumber
...
func NewParseNumberWithDefaults() *ParseNumber {
	this := ParseNumber{}
	var operator string = "PARSE_NUMBER"
	this.Operator = operator
	return &this
}
...
func (o ParseNumber) MarshalJSON() ([]byte, error) {
...
func (o ParseNumber) ToMap() (map[string]interface{}, error) {
...
func (o *ParseNumber) UnmarshalJSON(data []byte) (err error) {
	...
	varParseNumber := _ParseNumber{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varParseNumber)

	if err != nil {
		return err
	}

	*o = ParseNumber(varParseNumber)

	return err
}

type NullableParseNumber struct {
	value *ParseNumber
	isSet bool
}

func (v NullableParseNumber) Get() *ParseNumber {
	return v.value
}

func (v *NullableParseNumber) Set(val *ParseNumber) {
	v.value = val
	v.isSet = true
}

func (v NullableParseNumber) IsSet() bool {
	return v.isSet
}

func (v *NullableParseNumber) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParseNumber(val *ParseNumber) *NullableParseNumber {
	return &NullableParseNumber{value: val, isSet: true}
}

func (v NullableParseNumber) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParseNumber) UnmarshalJSON(src []byte) error {
	v.isSet = true
