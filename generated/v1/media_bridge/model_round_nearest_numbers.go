...
// checks if the RoundNearestNumbers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoundNearestNumbers{}

// RoundNearestNumbers struct for RoundNearestNumbers
...
type _RoundNearestNumbers RoundNearestNumbers
...
func NewRoundNearestNumbersWithDefaults() *RoundNearestNumbers {
	this := RoundNearestNumbers{}
	var operator string = "ROUND_NEAREST"
	this.Operator = operator
	return &this
}
...
func (o RoundNearestNumbers) MarshalJSON() ([]byte, error) {
...
func (o RoundNearestNumbers) ToMap() (map[string]interface{}, error) {
...
func (o *RoundNearestNumbers) UnmarshalJSON(data []byte) (err error) {
	...
	varRoundNearestNumbers := _RoundNearestNumbers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRoundNearestNumbers)

	if err != nil {
		return err
	}

	*o = RoundNearestNumbers(varRoundNearestNumbers)

	return err
}

type NullableRoundNearestNumbers struct {
	value *RoundNearestNumbers
	isSet bool
}

func (v NullableRoundNearestNumbers) Get() *RoundNearestNumbers {
	return v.value
}

func (v *NullableRoundNearestNumbers) Set(val *RoundNearestNumbers) {
	v.value = val
	v.isSet = true
}

func (v NullableRoundNearestNumbers) IsSet() bool {
	return v.isSet
}

func (v *NullableRoundNearestNumbers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoundNearestNumbers(val *RoundNearestNumbers) *NullableRoundNearestNumbers {
	return &NullableRoundNearestNumbers{value: val, isSet: true}
}

func (v NullableRoundNearestNumbers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoundNearestNumbers) UnmarshalJSON(src []byte) error {
	v.isSet = true
