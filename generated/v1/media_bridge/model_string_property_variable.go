...
// checks if the StringPropertyVariable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StringPropertyVariable{}

// StringPropertyVariable struct for StringPropertyVariable
...
type _StringPropertyVariable StringPropertyVariable
...
func NewStringPropertyVariableWithDefaults() *StringPropertyVariable {
	this := StringPropertyVariable{}
	var operator string = "STRING_PROPERTY_VARIABLE"
	this.Operator = operator
	return &this
}
...
func (o StringPropertyVariable) MarshalJSON() ([]byte, error) {
...
func (o StringPropertyVariable) ToMap() (map[string]interface{}, error) {
...
func (o *StringPropertyVariable) UnmarshalJSON(data []byte) (err error) {
	...
	varStringPropertyVariable := _StringPropertyVariable{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStringPropertyVariable)

	if err != nil {
		return err
	}

	*o = StringPropertyVariable(varStringPropertyVariable)

	return err
}

type NullableStringPropertyVariable struct {
	value *StringPropertyVariable
	isSet bool
}

func (v NullableStringPropertyVariable) Get() *StringPropertyVariable {
	return v.value
}

func (v *NullableStringPropertyVariable) Set(val *StringPropertyVariable) {
	v.value = val
	v.isSet = true
}

func (v NullableStringPropertyVariable) IsSet() bool {
	return v.isSet
}

func (v *NullableStringPropertyVariable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStringPropertyVariable(val *StringPropertyVariable) *NullableStringPropertyVariable {
	return &NullableStringPropertyVariable{value: val, isSet: true}
}

func (v NullableStringPropertyVariable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStringPropertyVariable) UnmarshalJSON(src []byte) error {
	v.isSet = true
