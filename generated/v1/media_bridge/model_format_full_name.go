...
// checks if the FormatFullName type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormatFullName{}

// FormatFullName struct for FormatFullName
...
type _FormatFullName FormatFullName
...
func NewFormatFullNameWithDefaults() *FormatFullName {
	this := FormatFullName{}
	var operator string = "FORMAT_FULL_NAME"
	this.Operator = operator
	return &this
}
...
func (o FormatFullName) MarshalJSON() ([]byte, error) {
...
func (o FormatFullName) ToMap() (map[string]interface{}, error) {
...
func (o *FormatFullName) UnmarshalJSON(data []byte) (err error) {
	...
	varFormatFullName := _FormatFullName{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFormatFullName)

	if err != nil {
		return err
	}

	*o = FormatFullName(varFormatFullName)

	return err
}

type NullableFormatFullName struct {
	value *FormatFullName
	isSet bool
}

func (v NullableFormatFullName) Get() *FormatFullName {
	return v.value
}

func (v *NullableFormatFullName) Set(val *FormatFullName) {
	v.value = val
	v.isSet = true
}

func (v NullableFormatFullName) IsSet() bool {
	return v.isSet
}

func (v *NullableFormatFullName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormatFullName(val *FormatFullName) *NullableFormatFullName {
	return &NullableFormatFullName{value: val, isSet: true}
}

func (v NullableFormatFullName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormatFullName) UnmarshalJSON(src []byte) error {
	v.isSet = true
