...
// checks if the Now type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Now{}
...
func (o Now) MarshalJSON() ([]byte, error) {
...
func (o Now) ToMap() (map[string]interface{}, error) {
...
func (o *Now) UnmarshalJSON(data []byte) (err error) {
...
type NullableNow struct {
	value *Now
	isSet bool
}

func (v NullableNow) Get() *Now {
	return v.value
}

func (v *NullableNow) Set(val *Now) {
	v.value = val
	v.isSet = true
}

func (v NullableNow) IsSet() bool {
	return v.isSet
}

func (v *NullableNow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNow(val *Now) *NullableNow {
	return &NullableNow{value: val, isSet: true}
}

func (v NullableNow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNow) UnmarshalJSON(src []byte) error {
	v.isSet = true
