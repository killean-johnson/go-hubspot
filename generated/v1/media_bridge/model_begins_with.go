...
// checks if the BeginsWith type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BeginsWith{}

// BeginsWith struct for BeginsWith
...
func NewBeginsWithWithDefaults() *BeginsWith {
	this := BeginsWith{}
	var operator string = "BEGINS_WITH"
	this.Operator = operator
	return &this
}
...
func (o BeginsWith) MarshalJSON() ([]byte, error) {
...
func (o BeginsWith) ToMap() (map[string]interface{}, error) {
...
func (o *BeginsWith) UnmarshalJSON(data []byte) (err error) {
	...
	varBeginsWith := _BeginsWith{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBeginsWith)

	if err != nil {
		return err
	}

	*o = BeginsWith(varBeginsWith)

	return err
}

type NullableBeginsWith struct {
	value *BeginsWith
	isSet bool
}

func (v NullableBeginsWith) Get() *BeginsWith {
	return v.value
}

func (v *NullableBeginsWith) Set(val *BeginsWith) {
	v.value = val
	v.isSet = true
}

func (v NullableBeginsWith) IsSet() bool {
	return v.isSet
}

func (v *NullableBeginsWith) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBeginsWith(val *BeginsWith) *NullableBeginsWith {
	return &NullableBeginsWith{value: val, isSet: true}
}

func (v NullableBeginsWith) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBeginsWith) UnmarshalJSON(src []byte) error {
	v.isSet = true
