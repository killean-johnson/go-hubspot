...
// checks if the ExtractMostRecentPlainTextEmailReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtractMostRecentPlainTextEmailReply{}

// ExtractMostRecentPlainTextEmailReply struct for ExtractMostRecentPlainTextEmailReply
...
type _ExtractMostRecentPlainTextEmailReply ExtractMostRecentPlainTextEmailReply
...
func NewExtractMostRecentPlainTextEmailReply(operator string) *ExtractMostRecentPlainTextEmailReply {
	this := ExtractMostRecentPlainTextEmailReply{}
...
func NewExtractMostRecentPlainTextEmailReplyWithDefaults() *ExtractMostRecentPlainTextEmailReply {
	this := ExtractMostRecentPlainTextEmailReply{}
	var operator string = "EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY"
	this.Operator = operator
	return &this
}
...
func (o ExtractMostRecentPlainTextEmailReply) MarshalJSON() ([]byte, error) {
...
func (o ExtractMostRecentPlainTextEmailReply) ToMap() (map[string]interface{}, error) {
...
func (o *ExtractMostRecentPlainTextEmailReply) UnmarshalJSON(data []byte) (err error) {
	...
	varExtractMostRecentPlainTextEmailReply := _ExtractMostRecentPlainTextEmailReply{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExtractMostRecentPlainTextEmailReply)

	if err != nil {
		return err
	}

	*o = ExtractMostRecentPlainTextEmailReply(varExtractMostRecentPlainTextEmailReply)

	return err
}

type NullableExtractMostRecentPlainTextEmailReply struct {
	value *ExtractMostRecentPlainTextEmailReply
	isSet bool
}

func (v NullableExtractMostRecentPlainTextEmailReply) Get() *ExtractMostRecentPlainTextEmailReply {
	return v.value
}

func (v *NullableExtractMostRecentPlainTextEmailReply) Set(val *ExtractMostRecentPlainTextEmailReply) {
	v.value = val
	v.isSet = true
}

func (v NullableExtractMostRecentPlainTextEmailReply) IsSet() bool {
	return v.isSet
}

func (v *NullableExtractMostRecentPlainTextEmailReply) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtractMostRecentPlainTextEmailReply(val *ExtractMostRecentPlainTextEmailReply) *NullableExtractMostRecentPlainTextEmailReply {
	return &NullableExtractMostRecentPlainTextEmailReply{value: val, isSet: true}
}

func (v NullableExtractMostRecentPlainTextEmailReply) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtractMostRecentPlainTextEmailReply) UnmarshalJSON(src []byte) error {
	v.isSet = true
