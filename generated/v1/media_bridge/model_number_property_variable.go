...
// checks if the NumberPropertyVariable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NumberPropertyVariable{}

// NumberPropertyVariable struct for NumberPropertyVariable
...
type _NumberPropertyVariable NumberPropertyVariable
...
func NewNumberPropertyVariableWithDefaults() *NumberPropertyVariable {
	this := NumberPropertyVariable{}
	var operator string = "NUMBER_PROPERTY_VARIABLE"
	this.Operator = operator
	return &this
}
...
func (o NumberPropertyVariable) MarshalJSON() ([]byte, error) {
...
func (o NumberPropertyVariable) ToMap() (map[string]interface{}, error) {
...
func (o *NumberPropertyVariable) UnmarshalJSON(data []byte) (err error) {
	...
	varNumberPropertyVariable := _NumberPropertyVariable{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNumberPropertyVariable)

	if err != nil {
		return err
	}

	*o = NumberPropertyVariable(varNumberPropertyVariable)

	return err
}

type NullableNumberPropertyVariable struct {
	value *NumberPropertyVariable
	isSet bool
}

func (v NullableNumberPropertyVariable) Get() *NumberPropertyVariable {
	return v.value
}

func (v *NullableNumberPropertyVariable) Set(val *NumberPropertyVariable) {
	v.value = val
	v.isSet = true
}

func (v NullableNumberPropertyVariable) IsSet() bool {
	return v.isSet
}

func (v *NullableNumberPropertyVariable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNumberPropertyVariable(val *NumberPropertyVariable) *NullableNumberPropertyVariable {
	return &NullableNumberPropertyVariable{value: val, isSet: true}
}

func (v NullableNumberPropertyVariable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNumberPropertyVariable) UnmarshalJSON(src []byte) error {
	v.isSet = true
