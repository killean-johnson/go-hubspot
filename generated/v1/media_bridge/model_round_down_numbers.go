...
// checks if the RoundDownNumbers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoundDownNumbers{}

// RoundDownNumbers struct for RoundDownNumbers
...
type _RoundDownNumbers RoundDownNumbers
...
func NewRoundDownNumbersWithDefaults() *RoundDownNumbers {
	this := RoundDownNumbers{}
	var operator string = "ROUND_DOWN"
	this.Operator = operator
	return &this
}
...
func (o RoundDownNumbers) MarshalJSON() ([]byte, error) {
...
func (o RoundDownNumbers) ToMap() (map[string]interface{}, error) {
...
func (o *RoundDownNumbers) UnmarshalJSON(data []byte) (err error) {
	...
	varRoundDownNumbers := _RoundDownNumbers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRoundDownNumbers)

	if err != nil {
		return err
	}

	*o = RoundDownNumbers(varRoundDownNumbers)

	return err
}

type NullableRoundDownNumbers struct {
	value *RoundDownNumbers
	isSet bool
}

func (v NullableRoundDownNumbers) Get() *RoundDownNumbers {
	return v.value
}

func (v *NullableRoundDownNumbers) Set(val *RoundDownNumbers) {
	v.value = val
	v.isSet = true
}

func (v NullableRoundDownNumbers) IsSet() bool {
	return v.isSet
}

func (v *NullableRoundDownNumbers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoundDownNumbers(val *RoundDownNumbers) *NullableRoundDownNumbers {
	return &NullableRoundDownNumbers{value: val, isSet: true}
}

func (v NullableRoundDownNumbers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoundDownNumbers) UnmarshalJSON(src []byte) error {
	v.isSet = true
