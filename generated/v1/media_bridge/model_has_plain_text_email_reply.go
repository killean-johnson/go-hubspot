...
// checks if the HasPlainTextEmailReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HasPlainTextEmailReply{}

// HasPlainTextEmailReply struct for HasPlainTextEmailReply
...
type _HasPlainTextEmailReply HasPlainTextEmailReply
...
func NewHasPlainTextEmailReplyWithDefaults() *HasPlainTextEmailReply {
	this := HasPlainTextEmailReply{}
	var operator string = "HAS_PLAIN_TEXT_EMAIL_REPLY"
	this.Operator = operator
	return &this
}
...
func (o HasPlainTextEmailReply) MarshalJSON() ([]byte, error) {
...
func (o HasPlainTextEmailReply) ToMap() (map[string]interface{}, error) {
...
func (o *HasPlainTextEmailReply) UnmarshalJSON(data []byte) (err error) {
	...
	varHasPlainTextEmailReply := _HasPlainTextEmailReply{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHasPlainTextEmailReply)

	if err != nil {
		return err
	}

	*o = HasPlainTextEmailReply(varHasPlainTextEmailReply)

	return err
}

type NullableHasPlainTextEmailReply struct {
	value *HasPlainTextEmailReply
	isSet bool
}

func (v NullableHasPlainTextEmailReply) Get() *HasPlainTextEmailReply {
	return v.value
}

func (v *NullableHasPlainTextEmailReply) Set(val *HasPlainTextEmailReply) {
	v.value = val
	v.isSet = true
}

func (v NullableHasPlainTextEmailReply) IsSet() bool {
	return v.isSet
}

func (v *NullableHasPlainTextEmailReply) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHasPlainTextEmailReply(val *HasPlainTextEmailReply) *NullableHasPlainTextEmailReply {
	return &NullableHasPlainTextEmailReply{value: val, isSet: true}
}

func (v NullableHasPlainTextEmailReply) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHasPlainTextEmailReply) UnmarshalJSON(src []byte) error {
	v.isSet = true
