...
// checks if the MinNumbers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MinNumbers{}

// MinNumbers struct for MinNumbers
...
func NewMinNumbersWithDefaults() *MinNumbers {
	this := MinNumbers{}
	var operator string = "MIN_NUMBERS"
	this.Operator = operator
	return &this
}
...
func (o MinNumbers) MarshalJSON() ([]byte, error) {
...
func (o MinNumbers) ToMap() (map[string]interface{}, error) {
...
func (o *MinNumbers) UnmarshalJSON(data []byte) (err error) {
	...
	varMinNumbers := _MinNumbers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMinNumbers)

	if err != nil {
		return err
	}

	*o = MinNumbers(varMinNumbers)

	return err
}

type NullableMinNumbers struct {
	value *MinNumbers
	isSet bool
}

func (v NullableMinNumbers) Get() *MinNumbers {
	return v.value
}

func (v *NullableMinNumbers) Set(val *MinNumbers) {
	v.value = val
	v.isSet = true
}

func (v NullableMinNumbers) IsSet() bool {
	return v.isSet
}

func (v *NullableMinNumbers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMinNumbers(val *MinNumbers) *NullableMinNumbers {
	return &NullableMinNumbers{value: val, isSet: true}
}

func (v NullableMinNumbers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMinNumbers) UnmarshalJSON(src []byte) error {
	v.isSet = true
