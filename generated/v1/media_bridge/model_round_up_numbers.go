...
// checks if the RoundUpNumbers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoundUpNumbers{}

// RoundUpNumbers struct for RoundUpNumbers
...
type _RoundUpNumbers RoundUpNumbers
...
func (o RoundUpNumbers) MarshalJSON() ([]byte, error) {
...
func (o RoundUpNumbers) ToMap() (map[string]interface{}, error) {
...
func (o *RoundUpNumbers) UnmarshalJSON(data []byte) (err error) {
	...
	varRoundUpNumbers := _RoundUpNumbers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRoundUpNumbers)

	if err != nil {
		return err
	}

	*o = RoundUpNumbers(varRoundUpNumbers)

	return err
}

type NullableRoundUpNumbers struct {
	value *RoundUpNumbers
	isSet bool
}

func (v NullableRoundUpNumbers) Get() *RoundUpNumbers {
	return v.value
}

func (v *NullableRoundUpNumbers) Set(val *RoundUpNumbers) {
	v.value = val
	v.isSet = true
}

func (v NullableRoundUpNumbers) IsSet() bool {
	return v.isSet
}

func (v *NullableRoundUpNumbers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoundUpNumbers(val *RoundUpNumbers) *NullableRoundUpNumbers {
	return &NullableRoundUpNumbers{value: val, isSet: true}
}

func (v NullableRoundUpNumbers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoundUpNumbers) UnmarshalJSON(src []byte) error {
	v.isSet = true
