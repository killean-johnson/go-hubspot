...
// checks if the IsEngagementType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IsEngagementType{}

// IsEngagementType struct for IsEngagementType
...
type _IsEngagementType IsEngagementType
...
func NewIsEngagementTypeWithDefaults() *IsEngagementType {
	this := IsEngagementType{}
	var operator string = "IS_ENGAGEMENT_TYPE"
	this.Operator = operator
	return &this
}
...
func (o IsEngagementType) MarshalJSON() ([]byte, error) {
...
func (o IsEngagementType) ToMap() (map[string]interface{}, error) {
...
func (o *IsEngagementType) UnmarshalJSON(data []byte) (err error) {
	...
	varIsEngagementType := _IsEngagementType{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIsEngagementType)

	if err != nil {
		return err
	}

	*o = IsEngagementType(varIsEngagementType)

	return err
}

type NullableIsEngagementType struct {
	value *IsEngagementType
	isSet bool
}

func (v NullableIsEngagementType) Get() *IsEngagementType {
	return v.value
}

func (v *NullableIsEngagementType) Set(val *IsEngagementType) {
	v.value = val
	v.isSet = true
}

func (v NullableIsEngagementType) IsSet() bool {
	return v.isSet
}

func (v *NullableIsEngagementType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIsEngagementType(val *IsEngagementType) *NullableIsEngagementType {
	return &NullableIsEngagementType{value: val, isSet: true}
}

func (v NullableIsEngagementType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIsEngagementType) UnmarshalJSON(src []byte) error {
	v.isSet = true
