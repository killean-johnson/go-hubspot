...
// ApiEventBasedEnrollmentCriteriaRefinementCriteria - List-based criteria to further refine which contacts will enroll in this flow.
type ApiEventBasedEnrollmentCriteriaRefinementCriteria struct {
...
// PublicAndFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria is a convenience function that returns PublicAndFilterBranch wrapped in ApiEventBasedEnrollmentCriteriaRefinementCriteria
func PublicAndFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria(v *PublicAndFilterBranch) ApiEventBasedEnrollmentCriteriaRefinementCriteria {
	return ApiEventBasedEnrollmentCriteriaRefinementCriteria{
		PublicAndFilterBranch: v,
	}
}

// PublicAssociationFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria is a convenience function that returns PublicAssociationFilterBranch wrapped in ApiEventBasedEnrollmentCriteriaRefinementCriteria
func PublicAssociationFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria(v *PublicAssociationFilterBranch) ApiEventBasedEnrollmentCriteriaRefinementCriteria {
	return ApiEventBasedEnrollmentCriteriaRefinementCriteria{
		PublicAssociationFilterBranch: v,
	}
}

// PublicNotAllFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria is a convenience function that returns PublicNotAllFilterBranch wrapped in ApiEventBasedEnrollmentCriteriaRefinementCriteria
func PublicNotAllFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria(v *PublicNotAllFilterBranch) ApiEventBasedEnrollmentCriteriaRefinementCriteria {
	return ApiEventBasedEnrollmentCriteriaRefinementCriteria{
		PublicNotAllFilterBranch: v,
	}
}

// PublicNotAnyFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria is a convenience function that returns PublicNotAnyFilterBranch wrapped in ApiEventBasedEnrollmentCriteriaRefinementCriteria
func PublicNotAnyFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria(v *PublicNotAnyFilterBranch) ApiEventBasedEnrollmentCriteriaRefinementCriteria {
	return ApiEventBasedEnrollmentCriteriaRefinementCriteria{
		PublicNotAnyFilterBranch: v,
	}
}

// PublicOrFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria is a convenience function that returns PublicOrFilterBranch wrapped in ApiEventBasedEnrollmentCriteriaRefinementCriteria
func PublicOrFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria(v *PublicOrFilterBranch) ApiEventBasedEnrollmentCriteriaRefinementCriteria {
	return ApiEventBasedEnrollmentCriteriaRefinementCriteria{
		PublicOrFilterBranch: v,
	}
}

// PublicPropertyAssociationFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria is a convenience function that returns PublicPropertyAssociationFilterBranch wrapped in ApiEventBasedEnrollmentCriteriaRefinementCriteria
func PublicPropertyAssociationFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria(v *PublicPropertyAssociationFilterBranch) ApiEventBasedEnrollmentCriteriaRefinementCriteria {
	return ApiEventBasedEnrollmentCriteriaRefinementCriteria{
		PublicPropertyAssociationFilterBranch: v,
	}
}

// PublicRestrictedFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria is a convenience function that returns PublicRestrictedFilterBranch wrapped in ApiEventBasedEnrollmentCriteriaRefinementCriteria
func PublicRestrictedFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria(v *PublicRestrictedFilterBranch) ApiEventBasedEnrollmentCriteriaRefinementCriteria {
	return ApiEventBasedEnrollmentCriteriaRefinementCriteria{
		PublicRestrictedFilterBranch: v,
	}
}

// PublicUnifiedEventsFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria is a convenience function that returns PublicUnifiedEventsFilterBranch wrapped in ApiEventBasedEnrollmentCriteriaRefinementCriteria
func PublicUnifiedEventsFilterBranchAsApiEventBasedEnrollmentCriteriaRefinementCriteria(v *PublicUnifiedEventsFilterBranch) ApiEventBasedEnrollmentCriteriaRefinementCriteria {
	return ApiEventBasedEnrollmentCriteriaRefinementCriteria{
...
func (dst *ApiEventBasedEnrollmentCriteriaRefinementCriteria) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ApiEventBasedEnrollmentCriteriaRefinementCriteria)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ApiEventBasedEnrollmentCriteriaRefinementCriteria)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ApiEventBasedEnrollmentCriteriaRefinementCriteria) MarshalJSON() ([]byte, error) {
...
func (obj *ApiEventBasedEnrollmentCriteriaRefinementCriteria) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj ApiEventBasedEnrollmentCriteriaRefinementCriteria) GetActualInstanceValue() (interface{}) {
	if obj.PublicAndFilterBranch != nil {
		return *obj.PublicAndFilterBranch
	}
...
type NullableApiEventBasedEnrollmentCriteriaRefinementCriteria struct {
	value *ApiEventBasedEnrollmentCriteriaRefinementCriteria
	isSet bool
}

func (v NullableApiEventBasedEnrollmentCriteriaRefinementCriteria) Get() *ApiEventBasedEnrollmentCriteriaRefinementCriteria {
	return v.value
}

func (v *NullableApiEventBasedEnrollmentCriteriaRefinementCriteria) Set(val *ApiEventBasedEnrollmentCriteriaRefinementCriteria) {
	v.value = val
	v.isSet = true
}

func (v NullableApiEventBasedEnrollmentCriteriaRefinementCriteria) IsSet() bool {
	return v.isSet
}

func (v *NullableApiEventBasedEnrollmentCriteriaRefinementCriteria) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiEventBasedEnrollmentCriteriaRefinementCriteria(val *ApiEventBasedEnrollmentCriteriaRefinementCriteria) *NullableApiEventBasedEnrollmentCriteriaRefinementCriteria {
	return &NullableApiEventBasedEnrollmentCriteriaRefinementCriteria{value: val, isSet: true}
}

func (v NullableApiEventBasedEnrollmentCriteriaRefinementCriteria) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiEventBasedEnrollmentCriteriaRefinementCriteria) UnmarshalJSON(src []byte) error {
	v.isSet = true
