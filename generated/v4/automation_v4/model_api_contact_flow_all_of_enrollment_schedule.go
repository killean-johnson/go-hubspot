...
// ApiContactFlowAllOfEnrollmentSchedule - struct for ApiContactFlowAllOfEnrollmentSchedule
type ApiContactFlowAllOfEnrollmentSchedule struct {
...
// ApiDailyEnrollmentScheduleAsApiContactFlowAllOfEnrollmentSchedule is a convenience function that returns ApiDailyEnrollmentSchedule wrapped in ApiContactFlowAllOfEnrollmentSchedule
func ApiDailyEnrollmentScheduleAsApiContactFlowAllOfEnrollmentSchedule(v *ApiDailyEnrollmentSchedule) ApiContactFlowAllOfEnrollmentSchedule {
	return ApiContactFlowAllOfEnrollmentSchedule{
		ApiDailyEnrollmentSchedule: v,
	}
}

// ApiMonthlyRelativeDaysEnrollmentScheduleAsApiContactFlowAllOfEnrollmentSchedule is a convenience function that returns ApiMonthlyRelativeDaysEnrollmentSchedule wrapped in ApiContactFlowAllOfEnrollmentSchedule
func ApiMonthlyRelativeDaysEnrollmentScheduleAsApiContactFlowAllOfEnrollmentSchedule(v *ApiMonthlyRelativeDaysEnrollmentSchedule) ApiContactFlowAllOfEnrollmentSchedule {
	return ApiContactFlowAllOfEnrollmentSchedule{
		ApiMonthlyRelativeDaysEnrollmentSchedule: v,
	}
}

// ApiMonthlySpecificDaysEnrollmentScheduleAsApiContactFlowAllOfEnrollmentSchedule is a convenience function that returns ApiMonthlySpecificDaysEnrollmentSchedule wrapped in ApiContactFlowAllOfEnrollmentSchedule
func ApiMonthlySpecificDaysEnrollmentScheduleAsApiContactFlowAllOfEnrollmentSchedule(v *ApiMonthlySpecificDaysEnrollmentSchedule) ApiContactFlowAllOfEnrollmentSchedule {
	return ApiContactFlowAllOfEnrollmentSchedule{
		ApiMonthlySpecificDaysEnrollmentSchedule: v,
	}
}

// ApiPropertyBasedEnrollmentScheduleAsApiContactFlowAllOfEnrollmentSchedule is a convenience function that returns ApiPropertyBasedEnrollmentSchedule wrapped in ApiContactFlowAllOfEnrollmentSchedule
func ApiPropertyBasedEnrollmentScheduleAsApiContactFlowAllOfEnrollmentSchedule(v *ApiPropertyBasedEnrollmentSchedule) ApiContactFlowAllOfEnrollmentSchedule {
	return ApiContactFlowAllOfEnrollmentSchedule{
		ApiPropertyBasedEnrollmentSchedule: v,
	}
}

// ApiWeeklyEnrollmentScheduleAsApiContactFlowAllOfEnrollmentSchedule is a convenience function that returns ApiWeeklyEnrollmentSchedule wrapped in ApiContactFlowAllOfEnrollmentSchedule
func ApiWeeklyEnrollmentScheduleAsApiContactFlowAllOfEnrollmentSchedule(v *ApiWeeklyEnrollmentSchedule) ApiContactFlowAllOfEnrollmentSchedule {
	return ApiContactFlowAllOfEnrollmentSchedule{
		ApiWeeklyEnrollmentSchedule: v,
	}
}

// ApiYearlyEnrollmentScheduleAsApiContactFlowAllOfEnrollmentSchedule is a convenience function that returns ApiYearlyEnrollmentSchedule wrapped in ApiContactFlowAllOfEnrollmentSchedule
func ApiYearlyEnrollmentScheduleAsApiContactFlowAllOfEnrollmentSchedule(v *ApiYearlyEnrollmentSchedule) ApiContactFlowAllOfEnrollmentSchedule {
	return ApiContactFlowAllOfEnrollmentSchedule{
...
func (dst *ApiContactFlowAllOfEnrollmentSchedule) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ApiContactFlowAllOfEnrollmentSchedule)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ApiContactFlowAllOfEnrollmentSchedule)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ApiContactFlowAllOfEnrollmentSchedule) MarshalJSON() ([]byte, error) {
...
func (obj *ApiContactFlowAllOfEnrollmentSchedule) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj ApiContactFlowAllOfEnrollmentSchedule) GetActualInstanceValue() (interface{}) {
	if obj.ApiDailyEnrollmentSchedule != nil {
		return *obj.ApiDailyEnrollmentSchedule
	}
...
type NullableApiContactFlowAllOfEnrollmentSchedule struct {
	value *ApiContactFlowAllOfEnrollmentSchedule
	isSet bool
}

func (v NullableApiContactFlowAllOfEnrollmentSchedule) Get() *ApiContactFlowAllOfEnrollmentSchedule {
	return v.value
}

func (v *NullableApiContactFlowAllOfEnrollmentSchedule) Set(val *ApiContactFlowAllOfEnrollmentSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableApiContactFlowAllOfEnrollmentSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableApiContactFlowAllOfEnrollmentSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiContactFlowAllOfEnrollmentSchedule(val *ApiContactFlowAllOfEnrollmentSchedule) *NullableApiContactFlowAllOfEnrollmentSchedule {
	return &NullableApiContactFlowAllOfEnrollmentSchedule{value: val, isSet: true}
}

func (v NullableApiContactFlowAllOfEnrollmentSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiContactFlowAllOfEnrollmentSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
