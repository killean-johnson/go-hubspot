...
// ApiPlatformFlowPutRequestAllOfEnrollmentSchedule - struct for ApiPlatformFlowPutRequestAllOfEnrollmentSchedule
type ApiPlatformFlowPutRequestAllOfEnrollmentSchedule struct {
...
// ApiDailyEnrollmentScheduleAsApiPlatformFlowPutRequestAllOfEnrollmentSchedule is a convenience function that returns ApiDailyEnrollmentSchedule wrapped in ApiPlatformFlowPutRequestAllOfEnrollmentSchedule
func ApiDailyEnrollmentScheduleAsApiPlatformFlowPutRequestAllOfEnrollmentSchedule(v *ApiDailyEnrollmentSchedule) ApiPlatformFlowPutRequestAllOfEnrollmentSchedule {
	return ApiPlatformFlowPutRequestAllOfEnrollmentSchedule{
		ApiDailyEnrollmentSchedule: v,
	}
}

// ApiMonthlyRelativeDaysEnrollmentScheduleAsApiPlatformFlowPutRequestAllOfEnrollmentSchedule is a convenience function that returns ApiMonthlyRelativeDaysEnrollmentSchedule wrapped in ApiPlatformFlowPutRequestAllOfEnrollmentSchedule
func ApiMonthlyRelativeDaysEnrollmentScheduleAsApiPlatformFlowPutRequestAllOfEnrollmentSchedule(v *ApiMonthlyRelativeDaysEnrollmentSchedule) ApiPlatformFlowPutRequestAllOfEnrollmentSchedule {
	return ApiPlatformFlowPutRequestAllOfEnrollmentSchedule{
		ApiMonthlyRelativeDaysEnrollmentSchedule: v,
	}
}

// ApiMonthlySpecificDaysEnrollmentScheduleAsApiPlatformFlowPutRequestAllOfEnrollmentSchedule is a convenience function that returns ApiMonthlySpecificDaysEnrollmentSchedule wrapped in ApiPlatformFlowPutRequestAllOfEnrollmentSchedule
func ApiMonthlySpecificDaysEnrollmentScheduleAsApiPlatformFlowPutRequestAllOfEnrollmentSchedule(v *ApiMonthlySpecificDaysEnrollmentSchedule) ApiPlatformFlowPutRequestAllOfEnrollmentSchedule {
	return ApiPlatformFlowPutRequestAllOfEnrollmentSchedule{
		ApiMonthlySpecificDaysEnrollmentSchedule: v,
	}
}

// ApiPropertyBasedEnrollmentScheduleAsApiPlatformFlowPutRequestAllOfEnrollmentSchedule is a convenience function that returns ApiPropertyBasedEnrollmentSchedule wrapped in ApiPlatformFlowPutRequestAllOfEnrollmentSchedule
func ApiPropertyBasedEnrollmentScheduleAsApiPlatformFlowPutRequestAllOfEnrollmentSchedule(v *ApiPropertyBasedEnrollmentSchedule) ApiPlatformFlowPutRequestAllOfEnrollmentSchedule {
	return ApiPlatformFlowPutRequestAllOfEnrollmentSchedule{
		ApiPropertyBasedEnrollmentSchedule: v,
	}
}

// ApiWeeklyEnrollmentScheduleAsApiPlatformFlowPutRequestAllOfEnrollmentSchedule is a convenience function that returns ApiWeeklyEnrollmentSchedule wrapped in ApiPlatformFlowPutRequestAllOfEnrollmentSchedule
func ApiWeeklyEnrollmentScheduleAsApiPlatformFlowPutRequestAllOfEnrollmentSchedule(v *ApiWeeklyEnrollmentSchedule) ApiPlatformFlowPutRequestAllOfEnrollmentSchedule {
	return ApiPlatformFlowPutRequestAllOfEnrollmentSchedule{
		ApiWeeklyEnrollmentSchedule: v,
	}
}

// ApiYearlyEnrollmentScheduleAsApiPlatformFlowPutRequestAllOfEnrollmentSchedule is a convenience function that returns ApiYearlyEnrollmentSchedule wrapped in ApiPlatformFlowPutRequestAllOfEnrollmentSchedule
func ApiYearlyEnrollmentScheduleAsApiPlatformFlowPutRequestAllOfEnrollmentSchedule(v *ApiYearlyEnrollmentSchedule) ApiPlatformFlowPutRequestAllOfEnrollmentSchedule {
	return ApiPlatformFlowPutRequestAllOfEnrollmentSchedule{
...
func (dst *ApiPlatformFlowPutRequestAllOfEnrollmentSchedule) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ApiPlatformFlowPutRequestAllOfEnrollmentSchedule)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ApiPlatformFlowPutRequestAllOfEnrollmentSchedule)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ApiPlatformFlowPutRequestAllOfEnrollmentSchedule) MarshalJSON() ([]byte, error) {
...
func (obj *ApiPlatformFlowPutRequestAllOfEnrollmentSchedule) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj ApiPlatformFlowPutRequestAllOfEnrollmentSchedule) GetActualInstanceValue() (interface{}) {
	if obj.ApiDailyEnrollmentSchedule != nil {
		return *obj.ApiDailyEnrollmentSchedule
	}
...
type NullableApiPlatformFlowPutRequestAllOfEnrollmentSchedule struct {
	value *ApiPlatformFlowPutRequestAllOfEnrollmentSchedule
	isSet bool
}

func (v NullableApiPlatformFlowPutRequestAllOfEnrollmentSchedule) Get() *ApiPlatformFlowPutRequestAllOfEnrollmentSchedule {
	return v.value
}

func (v *NullableApiPlatformFlowPutRequestAllOfEnrollmentSchedule) Set(val *ApiPlatformFlowPutRequestAllOfEnrollmentSchedule) {
	v.value = val
	v.isSet = true
}

func (v NullableApiPlatformFlowPutRequestAllOfEnrollmentSchedule) IsSet() bool {
	return v.isSet
}

func (v *NullableApiPlatformFlowPutRequestAllOfEnrollmentSchedule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiPlatformFlowPutRequestAllOfEnrollmentSchedule(val *ApiPlatformFlowPutRequestAllOfEnrollmentSchedule) *NullableApiPlatformFlowPutRequestAllOfEnrollmentSchedule {
	return &NullableApiPlatformFlowPutRequestAllOfEnrollmentSchedule{value: val, isSet: true}
}

func (v NullableApiPlatformFlowPutRequestAllOfEnrollmentSchedule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiPlatformFlowPutRequestAllOfEnrollmentSchedule) UnmarshalJSON(src []byte) error {
	v.isSet = true
