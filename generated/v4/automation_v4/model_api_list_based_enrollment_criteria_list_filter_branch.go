...
// ApiListBasedEnrollmentCriteriaListFilterBranch - The list filter branch that represents the enrollment trigger to this flow.
type ApiListBasedEnrollmentCriteriaListFilterBranch struct {
...
// PublicAndFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch is a convenience function that returns PublicAndFilterBranch wrapped in ApiListBasedEnrollmentCriteriaListFilterBranch
func PublicAndFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch(v *PublicAndFilterBranch) ApiListBasedEnrollmentCriteriaListFilterBranch {
	return ApiListBasedEnrollmentCriteriaListFilterBranch{
		PublicAndFilterBranch: v,
	}
}

// PublicAssociationFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch is a convenience function that returns PublicAssociationFilterBranch wrapped in ApiListBasedEnrollmentCriteriaListFilterBranch
func PublicAssociationFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch(v *PublicAssociationFilterBranch) ApiListBasedEnrollmentCriteriaListFilterBranch {
	return ApiListBasedEnrollmentCriteriaListFilterBranch{
		PublicAssociationFilterBranch: v,
	}
}

// PublicNotAllFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch is a convenience function that returns PublicNotAllFilterBranch wrapped in ApiListBasedEnrollmentCriteriaListFilterBranch
func PublicNotAllFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch(v *PublicNotAllFilterBranch) ApiListBasedEnrollmentCriteriaListFilterBranch {
	return ApiListBasedEnrollmentCriteriaListFilterBranch{
		PublicNotAllFilterBranch: v,
	}
}

// PublicNotAnyFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch is a convenience function that returns PublicNotAnyFilterBranch wrapped in ApiListBasedEnrollmentCriteriaListFilterBranch
func PublicNotAnyFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch(v *PublicNotAnyFilterBranch) ApiListBasedEnrollmentCriteriaListFilterBranch {
	return ApiListBasedEnrollmentCriteriaListFilterBranch{
		PublicNotAnyFilterBranch: v,
	}
}

// PublicOrFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch is a convenience function that returns PublicOrFilterBranch wrapped in ApiListBasedEnrollmentCriteriaListFilterBranch
func PublicOrFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch(v *PublicOrFilterBranch) ApiListBasedEnrollmentCriteriaListFilterBranch {
	return ApiListBasedEnrollmentCriteriaListFilterBranch{
		PublicOrFilterBranch: v,
	}
}

// PublicPropertyAssociationFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch is a convenience function that returns PublicPropertyAssociationFilterBranch wrapped in ApiListBasedEnrollmentCriteriaListFilterBranch
func PublicPropertyAssociationFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch(v *PublicPropertyAssociationFilterBranch) ApiListBasedEnrollmentCriteriaListFilterBranch {
	return ApiListBasedEnrollmentCriteriaListFilterBranch{
		PublicPropertyAssociationFilterBranch: v,
	}
}

// PublicRestrictedFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch is a convenience function that returns PublicRestrictedFilterBranch wrapped in ApiListBasedEnrollmentCriteriaListFilterBranch
func PublicRestrictedFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch(v *PublicRestrictedFilterBranch) ApiListBasedEnrollmentCriteriaListFilterBranch {
	return ApiListBasedEnrollmentCriteriaListFilterBranch{
		PublicRestrictedFilterBranch: v,
	}
}

// PublicUnifiedEventsFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch is a convenience function that returns PublicUnifiedEventsFilterBranch wrapped in ApiListBasedEnrollmentCriteriaListFilterBranch
func PublicUnifiedEventsFilterBranchAsApiListBasedEnrollmentCriteriaListFilterBranch(v *PublicUnifiedEventsFilterBranch) ApiListBasedEnrollmentCriteriaListFilterBranch {
	return ApiListBasedEnrollmentCriteriaListFilterBranch{
...
func (dst *ApiListBasedEnrollmentCriteriaListFilterBranch) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ApiListBasedEnrollmentCriteriaListFilterBranch)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ApiListBasedEnrollmentCriteriaListFilterBranch)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ApiListBasedEnrollmentCriteriaListFilterBranch) MarshalJSON() ([]byte, error) {
...
func (obj *ApiListBasedEnrollmentCriteriaListFilterBranch) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj ApiListBasedEnrollmentCriteriaListFilterBranch) GetActualInstanceValue() (interface{}) {
	if obj.PublicAndFilterBranch != nil {
		return *obj.PublicAndFilterBranch
	}
...
type NullableApiListBasedEnrollmentCriteriaListFilterBranch struct {
	value *ApiListBasedEnrollmentCriteriaListFilterBranch
	isSet bool
}

func (v NullableApiListBasedEnrollmentCriteriaListFilterBranch) Get() *ApiListBasedEnrollmentCriteriaListFilterBranch {
	return v.value
}

func (v *NullableApiListBasedEnrollmentCriteriaListFilterBranch) Set(val *ApiListBasedEnrollmentCriteriaListFilterBranch) {
	v.value = val
	v.isSet = true
}

func (v NullableApiListBasedEnrollmentCriteriaListFilterBranch) IsSet() bool {
	return v.isSet
}

func (v *NullableApiListBasedEnrollmentCriteriaListFilterBranch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiListBasedEnrollmentCriteriaListFilterBranch(val *ApiListBasedEnrollmentCriteriaListFilterBranch) *NullableApiListBasedEnrollmentCriteriaListFilterBranch {
	return &NullableApiListBasedEnrollmentCriteriaListFilterBranch{value: val, isSet: true}
}

func (v NullableApiListBasedEnrollmentCriteriaListFilterBranch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiListBasedEnrollmentCriteriaListFilterBranch) UnmarshalJSON(src []byte) error {
	v.isSet = true
