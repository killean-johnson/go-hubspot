...
// checks if the BatchResponsePublicBulkOptOutFromAllResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchResponsePublicBulkOptOutFromAllResponse{}

// BatchResponsePublicBulkOptOutFromAllResponse struct for BatchResponsePublicBulkOptOutFromAllResponse
type BatchResponsePublicBulkOptOutFromAllResponse struct {
	...
	Results []PublicBulkOptOutFromAllResponse `json:"results"`
	Errors []StandardError `json:"errors,omitempty"`
	Status string `json:"status"`
}

type _BatchResponsePublicBulkOptOutFromAllResponse BatchResponsePublicBulkOptOutFromAllResponse
...
func NewBatchResponsePublicBulkOptOutFromAllResponse(completedAt time.Time, startedAt time.Time, results []PublicBulkOptOutFromAllResponse, status string) *BatchResponsePublicBulkOptOutFromAllResponse {
	this := BatchResponsePublicBulkOptOutFromAllResponse{}
...
func (o *BatchResponsePublicBulkOptOutFromAllResponse) GetResults() []PublicBulkOptOutFromAllResponse {
	if o == nil {
		var ret []PublicBulkOptOutFromAllResponse
		return ret
	}
...
func (o BatchResponsePublicBulkOptOutFromAllResponse) MarshalJSON() ([]byte, error) {
...
func (o BatchResponsePublicBulkOptOutFromAllResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BatchResponsePublicBulkOptOutFromAllResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchResponsePublicBulkOptOutFromAllResponse := _BatchResponsePublicBulkOptOutFromAllResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchResponsePublicBulkOptOutFromAllResponse)

	if err != nil {
		return err
	}

	*o = BatchResponsePublicBulkOptOutFromAllResponse(varBatchResponsePublicBulkOptOutFromAllResponse)

	return err
}

type NullableBatchResponsePublicBulkOptOutFromAllResponse struct {
	value *BatchResponsePublicBulkOptOutFromAllResponse
	isSet bool
}

func (v NullableBatchResponsePublicBulkOptOutFromAllResponse) Get() *BatchResponsePublicBulkOptOutFromAllResponse {
	return v.value
}

func (v *NullableBatchResponsePublicBulkOptOutFromAllResponse) Set(val *BatchResponsePublicBulkOptOutFromAllResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchResponsePublicBulkOptOutFromAllResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchResponsePublicBulkOptOutFromAllResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchResponsePublicBulkOptOutFromAllResponse(val *BatchResponsePublicBulkOptOutFromAllResponse) *NullableBatchResponsePublicBulkOptOutFromAllResponse {
	return &NullableBatchResponsePublicBulkOptOutFromAllResponse{value: val, isSet: true}
}

func (v NullableBatchResponsePublicBulkOptOutFromAllResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchResponsePublicBulkOptOutFromAllResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
