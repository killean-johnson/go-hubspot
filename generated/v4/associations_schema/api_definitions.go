...
type ApiDeleteCrmV4AssociationsFromObjectTypeToObjectTypeLabelsAssociationTypeIdRemoveRequest struct {
	ctx context.Context
...
func (r ApiDeleteCrmV4AssociationsFromObjectTypeToObjectTypeLabelsAssociationTypeIdRemoveRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteCrmV4AssociationsFromObjectTypeToObjectTypeLabelsAssociationTypeIdRemoveExecute(r)
}

/*
DeleteCrmV4AssociationsFromObjectTypeToObjectTypeLabelsAssociationTypeIdRemove Delete
...
Deletes an association definition
 ...
 @return ApiDeleteCrmV4AssociationsFromObjectTypeToObjectTypeLabelsAssociationTypeIdRemoveRequest
*/
func (a *DefinitionsAPIService) DeleteCrmV4AssociationsFromObjectTypeToObjectTypeLabelsAssociationTypeIdRemove(ctx context.Context, fromObjectType string, toObjectType string, associationTypeId int32) ApiDeleteCrmV4AssociationsFromObjectTypeToObjectTypeLabelsAssociationTypeIdRemoveRequest {
	return ApiDeleteCrmV4AssociationsFromObjectTypeToObjectTypeLabelsAssociationTypeIdRemoveRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *DefinitionsAPIService) DeleteCrmV4AssociationsFromObjectTypeToObjectTypeLabelsAssociationTypeIdRemoveExecute(r ApiDeleteCrmV4AssociationsFromObjectTypeToObjectTypeLabelsAssociationTypeIdRemoveRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefinitionsAPIService.DeleteCrmV4AssociationsFromObjectTypeToObjectTypeLabelsAssociationTypeIdRemove")
	if err != nil {
