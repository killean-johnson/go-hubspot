...
// checks if the BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors{}

// BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors struct for BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors
type BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors struct {
...
type _BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors
...
func NewBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors(completedAt time.Time, startedAt time.Time, results []PublicAssociationDefinitionConfigurationUpdateResult, status string) *BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors {
	this := BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors{}
...
func (o BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors) MarshalJSON() ([]byte, error) {
...
func (o BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors) ToMap() (map[string]interface{}, error) {
...
func (o *BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors := _BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors)

	if err != nil {
		return err
	}

	*o = BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors(varBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors)

	return err
}

type NullableBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors struct {
	value *BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors
	isSet bool
}

func (v NullableBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors) Get() *BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors {
	return v.value
}

func (v *NullableBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors) Set(val *BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors(val *BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors) *NullableBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors {
	return &NullableBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors{value: val, isSet: true}
}

func (v NullableBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
