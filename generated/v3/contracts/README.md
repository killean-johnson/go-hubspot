...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsContractsContractId**](docs/BasicAPI.md#deletecrmv3objectscontractscontractid) | **Delete** /crm/v3/objects/contracts/{contractId} | Archive
*BasicAPI* | [**GetCrmV3ObjectsContracts**](docs/BasicAPI.md#getcrmv3objectscontracts) | **Get** /crm/v3/objects/contracts | List
*BasicAPI* | [**GetCrmV3ObjectsContractsContractId**](docs/BasicAPI.md#getcrmv3objectscontractscontractid) | **Get** /crm/v3/objects/contracts/{contractId} | Read
*BasicAPI* | [**PatchCrmV3ObjectsContractsContractId**](docs/BasicAPI.md#patchcrmv3objectscontractscontractid) | **Patch** /crm/v3/objects/contracts/{contractId} | Update
*BasicAPI* | [**PostCrmV3ObjectsContracts**](docs/BasicAPI.md#postcrmv3objectscontracts) | **Post** /crm/v3/objects/contracts | Create
*BatchAPI* | [**PostCrmV3ObjectsContractsBatchArchive**](docs/BatchAPI.md#postcrmv3objectscontractsbatcharchive) | **Post** /crm/v3/objects/contracts/batch/archive | Archive a batch of contracts by ID
*BatchAPI* | [**PostCrmV3ObjectsContractsBatchCreate**](docs/BatchAPI.md#postcrmv3objectscontractsbatchcreate) | **Post** /crm/v3/objects/contracts/batch/create | Create a batch of contracts
*BatchAPI* | [**PostCrmV3ObjectsContractsBatchRead**](docs/BatchAPI.md#postcrmv3objectscontractsbatchread) | **Post** /crm/v3/objects/contracts/batch/read | Read a batch of contracts by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsContractsBatchUpdate**](docs/BatchAPI.md#postcrmv3objectscontractsbatchupdate) | **Post** /crm/v3/objects/contracts/batch/update | Update a batch of contracts by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsContractsBatchUpsert**](docs/BatchAPI.md#postcrmv3objectscontractsbatchupsert) | **Post** /crm/v3/objects/contracts/batch/upsert | Create or update a batch of contracts by unique property values
*SearchAPI* | [**PostCrmV3ObjectsContractsSearch**](docs/SearchAPI.md#postcrmv3objectscontractssearch) | **Post** /crm/v3/objects/contracts/search | 
...
```go
auth := context.WithValue(context.Background(), contracts.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, contracts.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		contracts.ContextAPIKeys,
		map[string]contracts.APIKey{
