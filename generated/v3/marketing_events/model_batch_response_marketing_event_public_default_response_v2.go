...
// checks if the BatchResponseMarketingEventPublicDefaultResponseV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchResponseMarketingEventPublicDefaultResponseV2{}

// BatchResponseMarketingEventPublicDefaultResponseV2 struct for BatchResponseMarketingEventPublicDefaultResponseV2
...
type _BatchResponseMarketingEventPublicDefaultResponseV2 BatchResponseMarketingEventPublicDefaultResponseV2
...
func NewBatchResponseMarketingEventPublicDefaultResponseV2(completedAt time.Time, startedAt time.Time, results []MarketingEventPublicDefaultResponseV2, status string) *BatchResponseMarketingEventPublicDefaultResponseV2 {
	this := BatchResponseMarketingEventPublicDefaultResponseV2{}
...
func (o BatchResponseMarketingEventPublicDefaultResponseV2) MarshalJSON() ([]byte, error) {
...
func (o BatchResponseMarketingEventPublicDefaultResponseV2) ToMap() (map[string]interface{}, error) {
...
func (o *BatchResponseMarketingEventPublicDefaultResponseV2) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchResponseMarketingEventPublicDefaultResponseV2 := _BatchResponseMarketingEventPublicDefaultResponseV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchResponseMarketingEventPublicDefaultResponseV2)

	if err != nil {
		return err
	}

	*o = BatchResponseMarketingEventPublicDefaultResponseV2(varBatchResponseMarketingEventPublicDefaultResponseV2)

	return err
}

type NullableBatchResponseMarketingEventPublicDefaultResponseV2 struct {
	value *BatchResponseMarketingEventPublicDefaultResponseV2
	isSet bool
}

func (v NullableBatchResponseMarketingEventPublicDefaultResponseV2) Get() *BatchResponseMarketingEventPublicDefaultResponseV2 {
	return v.value
}

func (v *NullableBatchResponseMarketingEventPublicDefaultResponseV2) Set(val *BatchResponseMarketingEventPublicDefaultResponseV2) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchResponseMarketingEventPublicDefaultResponseV2) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchResponseMarketingEventPublicDefaultResponseV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchResponseMarketingEventPublicDefaultResponseV2(val *BatchResponseMarketingEventPublicDefaultResponseV2) *NullableBatchResponseMarketingEventPublicDefaultResponseV2 {
	return &NullableBatchResponseMarketingEventPublicDefaultResponseV2{value: val, isSet: true}
}

func (v NullableBatchResponseMarketingEventPublicDefaultResponseV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchResponseMarketingEventPublicDefaultResponseV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
