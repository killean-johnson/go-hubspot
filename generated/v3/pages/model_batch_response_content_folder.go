...
// checks if the BatchResponseContentFolder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchResponseContentFolder{}
...
type _BatchResponseContentFolder BatchResponseContentFolder
...
func NewBatchResponseContentFolder(completedAt time.Time, startedAt time.Time, results []ContentFolder, status string) *BatchResponseContentFolder {
	this := BatchResponseContentFolder{}
...
func (o BatchResponseContentFolder) MarshalJSON() ([]byte, error) {
...
func (o BatchResponseContentFolder) ToMap() (map[string]interface{}, error) {
...
func (o *BatchResponseContentFolder) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchResponseContentFolder := _BatchResponseContentFolder{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchResponseContentFolder)

	if err != nil {
		return err
	}

	*o = BatchResponseContentFolder(varBatchResponseContentFolder)

	return err
}

type NullableBatchResponseContentFolder struct {
	value *BatchResponseContentFolder
	isSet bool
}

func (v NullableBatchResponseContentFolder) Get() *BatchResponseContentFolder {
	return v.value
}

func (v *NullableBatchResponseContentFolder) Set(val *BatchResponseContentFolder) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchResponseContentFolder) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchResponseContentFolder) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchResponseContentFolder(val *BatchResponseContentFolder) *NullableBatchResponseContentFolder {
	return &NullableBatchResponseContentFolder{value: val, isSet: true}
}

func (v NullableBatchResponseContentFolder) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchResponseContentFolder) UnmarshalJSON(src []byte) error {
	v.isSet = true
