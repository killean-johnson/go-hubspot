# Go API client for partner_clients
...
```go
import partner_clients "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `partner_clients.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), partner_clients.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `partner_clients.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), partner_clients.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `partner_clients.ContextOperationServerIndices` and `partner_clients.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), partner_clients.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), partner_clients.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**GetCrmV3ObjectsPartnerClients**](docs/BasicAPI.md#getcrmv3objectspartnerclients) | **Get** /crm/v3/objects/partner_clients | Retrieve partner clients
*BasicAPI* | [**GetCrmV3ObjectsPartnerClientsPartnerClientId**](docs/BasicAPI.md#getcrmv3objectspartnerclientspartnerclientid) | **Get** /crm/v3/objects/partner_clients/{partnerClientId} | Retrieve a partner client
*BasicAPI* | [**PatchCrmV3ObjectsPartnerClientsPartnerClientId**](docs/BasicAPI.md#patchcrmv3objectspartnerclientspartnerclientid) | **Patch** /crm/v3/objects/partner_clients/{partnerClientId} | Update a partner client
*BatchAPI* | [**PostCrmV3ObjectsPartnerClientsBatchRead**](docs/BatchAPI.md#postcrmv3objectspartnerclientsbatchread) | **Post** /crm/v3/objects/partner_clients/batch/read | Retrieve a batch of partner clients
*BatchAPI* | [**PostCrmV3ObjectsPartnerClientsBatchUpdate**](docs/BatchAPI.md#postcrmv3objectspartnerclientsbatchupdate) | **Post** /crm/v3/objects/partner_clients/batch/update | Update a batch of partner clients
*SearchAPI* | [**PostCrmV3ObjectsPartnerClientsSearch**](docs/SearchAPI.md#postcrmv3objectspartnerclientssearch) | **Post** /crm/v3/objects/partner_clients/search | Search for partner clients
...
```go
auth := context.WithValue(context.Background(), partner_clients.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, partner_clients.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		partner_clients.ContextAPIKeys,
		map[string]partner_clients.APIKey{
