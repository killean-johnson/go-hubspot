...
// checks if the YearReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &YearReference{}

// YearReference struct for YearReference
...
type _YearReference YearReference
...
func (o YearReference) MarshalJSON() ([]byte, error) {
...
func (o YearReference) ToMap() (map[string]interface{}, error) {
...
func (o *YearReference) UnmarshalJSON(data []byte) (err error) {
	...
	varYearReference := _YearReference{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varYearReference)

	if err != nil {
		return err
	}

	*o = YearReference(varYearReference)

	return err
}

type NullableYearReference struct {
	value *YearReference
	isSet bool
}

func (v NullableYearReference) Get() *YearReference {
	return v.value
}

func (v *NullableYearReference) Set(val *YearReference) {
	v.value = val
	v.isSet = true
}

func (v NullableYearReference) IsSet() bool {
	return v.isSet
}

func (v *NullableYearReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableYearReference(val *YearReference) *NullableYearReference {
	return &NullableYearReference{value: val, isSet: true}
}

func (v NullableYearReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableYearReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
