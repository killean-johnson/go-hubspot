...
// checks if the RollingPropertyUpdatedOperation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RollingPropertyUpdatedOperation{}

// RollingPropertyUpdatedOperation struct for RollingPropertyUpdatedOperation
...
type _RollingPropertyUpdatedOperation RollingPropertyUpdatedOperation
...
func NewRollingPropertyUpdatedOperation(includeObjectsWithNoValueSet bool, propertyType string, operationType string, numberOfDays int32, operatorName string, operator string) *RollingPropertyUpdatedOperation {
	this := RollingPropertyUpdatedOperation{}
...
func NewRollingPropertyUpdatedOperationWithDefaults() *RollingPropertyUpdatedOperation {
	this := RollingPropertyUpdatedOperation{}
	var propertyType string = "rolling-property-updated"
	this.PropertyType = propertyType
	return &this
}
...
func (o RollingPropertyUpdatedOperation) MarshalJSON() ([]byte, error) {
...
func (o RollingPropertyUpdatedOperation) ToMap() (map[string]interface{}, error) {
...
func (o *RollingPropertyUpdatedOperation) UnmarshalJSON(data []byte) (err error) {
	...
	varRollingPropertyUpdatedOperation := _RollingPropertyUpdatedOperation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRollingPropertyUpdatedOperation)

	if err != nil {
		return err
	}

	*o = RollingPropertyUpdatedOperation(varRollingPropertyUpdatedOperation)

	return err
}

type NullableRollingPropertyUpdatedOperation struct {
	value *RollingPropertyUpdatedOperation
	isSet bool
}

func (v NullableRollingPropertyUpdatedOperation) Get() *RollingPropertyUpdatedOperation {
	return v.value
}

func (v *NullableRollingPropertyUpdatedOperation) Set(val *RollingPropertyUpdatedOperation) {
	v.value = val
	v.isSet = true
}

func (v NullableRollingPropertyUpdatedOperation) IsSet() bool {
	return v.isSet
}

func (v *NullableRollingPropertyUpdatedOperation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRollingPropertyUpdatedOperation(val *RollingPropertyUpdatedOperation) *NullableRollingPropertyUpdatedOperation {
	return &NullableRollingPropertyUpdatedOperation{value: val, isSet: true}
}

func (v NullableRollingPropertyUpdatedOperation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRollingPropertyUpdatedOperation) UnmarshalJSON(src []byte) error {
	v.isSet = true
