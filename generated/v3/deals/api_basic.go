...
*/
func (a *BasicAPIService) PostCrmV3ObjectsDealsMergeMerge(ctx context.Context) ApiPostCrmV3ObjectsDealsMergeMergeRequest {
	return ApiPostCrmV3ObjectsDealsMergeMergeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SimplePublicObject
func (a *BasicAPIService) PostCrmV3ObjectsDealsMergeMergeExecute(r ApiPostCrmV3ObjectsDealsMergeMergeRequest) (*SimplePublicObject, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BasicAPIService.PostCrmV3ObjectsDealsMergeMerge")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
