...
*BasicAPI* | [**PostCrmV3ObjectsTicketsMergeMerge**](docs/BasicAPI.md#postcrmv3objectsticketsmergemerge) | **Post** /crm/v3/objects/tickets/merge | Merge two tickets
...
*BatchAPI* | [**PostCrmV3ObjectsTicketsBatchUpdateUpdate**](docs/BatchAPI.md#postcrmv3objectsticketsbatchupdateupdate) | **Post** /crm/v3/objects/tickets/batch/update | Update a batch of tickets by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsTicketsBatchUpsertUpsert**](docs/BatchAPI.md#postcrmv3objectsticketsbatchupsertupsert) | **Post** /crm/v3/objects/tickets/batch/upsert | Create or update a batch of tickets by unique property values
*SearchAPI* | [**PostCrmV3ObjectsTicketsSearchDoSearch**](docs/SearchAPI.md#postcrmv3objectsticketssearchdosearch) | **Post** /crm/v3/objects/tickets/search | Search for tickets
