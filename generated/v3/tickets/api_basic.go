...
/*
PostCrmV3ObjectsTicketsMergeMerge Merge two tickets
...
*/
func (a *BasicAPIService) PostCrmV3ObjectsTicketsMergeMerge(ctx context.Context) ApiPostCrmV3ObjectsTicketsMergeMergeRequest {
	return ApiPostCrmV3ObjectsTicketsMergeMergeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SimplePublicObject
func (a *BasicAPIService) PostCrmV3ObjectsTicketsMergeMergeExecute(r ApiPostCrmV3ObjectsTicketsMergeMergeRequest) (*SimplePublicObject, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BasicAPIService.PostCrmV3ObjectsTicketsMergeMerge")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
