...
```go
import orders "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `orders.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), orders.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `orders.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), orders.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `orders.ContextOperationServerIndices` and `orders.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), orders.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), orders.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsOrdersOrderId**](docs/BasicAPI.md#deletecrmv3objectsordersorderid) | **Delete** /crm/v3/objects/orders/{orderId} | Archive
*BasicAPI* | [**GetCrmV3ObjectsOrders**](docs/BasicAPI.md#getcrmv3objectsorders) | **Get** /crm/v3/objects/orders | List
*BasicAPI* | [**GetCrmV3ObjectsOrdersOrderId**](docs/BasicAPI.md#getcrmv3objectsordersorderid) | **Get** /crm/v3/objects/orders/{orderId} | Read
*BasicAPI* | [**PatchCrmV3ObjectsOrdersOrderId**](docs/BasicAPI.md#patchcrmv3objectsordersorderid) | **Patch** /crm/v3/objects/orders/{orderId} | Update
*BasicAPI* | [**PostCrmV3ObjectsOrders**](docs/BasicAPI.md#postcrmv3objectsorders) | **Post** /crm/v3/objects/orders | Create
*BatchAPI* | [**PostCrmV3ObjectsOrdersBatchArchive**](docs/BatchAPI.md#postcrmv3objectsordersbatcharchive) | **Post** /crm/v3/objects/orders/batch/archive | Archive a batch of orders by ID
*BatchAPI* | [**PostCrmV3ObjectsOrdersBatchCreate**](docs/BatchAPI.md#postcrmv3objectsordersbatchcreate) | **Post** /crm/v3/objects/orders/batch/create | Create a batch of orders
*BatchAPI* | [**PostCrmV3ObjectsOrdersBatchRead**](docs/BatchAPI.md#postcrmv3objectsordersbatchread) | **Post** /crm/v3/objects/orders/batch/read | Read a batch of orders by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsOrdersBatchUpdate**](docs/BatchAPI.md#postcrmv3objectsordersbatchupdate) | **Post** /crm/v3/objects/orders/batch/update | Update a batch of orders by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsOrdersBatchUpsert**](docs/BatchAPI.md#postcrmv3objectsordersbatchupsert) | **Post** /crm/v3/objects/orders/batch/upsert | Create or update a batch of orders by unique property values
*SearchAPI* | [**PostCrmV3ObjectsOrdersSearch**](docs/SearchAPI.md#postcrmv3objectsorderssearch) | **Post** /crm/v3/objects/orders/search | 
...
```go
auth := context.WithValue(context.Background(), orders.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, orders.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		orders.ContextAPIKeys,
		map[string]orders.APIKey{
