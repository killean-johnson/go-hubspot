...
```go
import fees "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `fees.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), fees.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `fees.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), fees.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `fees.ContextOperationServerIndices` and `fees.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), fees.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), fees.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsFeesFeeId**](docs/BasicAPI.md#deletecrmv3objectsfeesfeeid) | **Delete** /crm/v3/objects/fees/{feeId} | Archive
*BasicAPI* | [**GetCrmV3ObjectsFees**](docs/BasicAPI.md#getcrmv3objectsfees) | **Get** /crm/v3/objects/fees | List
*BasicAPI* | [**GetCrmV3ObjectsFeesFeeId**](docs/BasicAPI.md#getcrmv3objectsfeesfeeid) | **Get** /crm/v3/objects/fees/{feeId} | Read
*BasicAPI* | [**PatchCrmV3ObjectsFeesFeeId**](docs/BasicAPI.md#patchcrmv3objectsfeesfeeid) | **Patch** /crm/v3/objects/fees/{feeId} | Update
*BasicAPI* | [**PostCrmV3ObjectsFees**](docs/BasicAPI.md#postcrmv3objectsfees) | **Post** /crm/v3/objects/fees | Create
*BatchAPI* | [**PostCrmV3ObjectsFeesBatchArchive**](docs/BatchAPI.md#postcrmv3objectsfeesbatcharchive) | **Post** /crm/v3/objects/fees/batch/archive | Archive a batch of fees by ID
*BatchAPI* | [**PostCrmV3ObjectsFeesBatchCreate**](docs/BatchAPI.md#postcrmv3objectsfeesbatchcreate) | **Post** /crm/v3/objects/fees/batch/create | Create a batch of fees
*BatchAPI* | [**PostCrmV3ObjectsFeesBatchRead**](docs/BatchAPI.md#postcrmv3objectsfeesbatchread) | **Post** /crm/v3/objects/fees/batch/read | Read a batch of fees by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsFeesBatchUpdate**](docs/BatchAPI.md#postcrmv3objectsfeesbatchupdate) | **Post** /crm/v3/objects/fees/batch/update | Update a batch of fees by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsFeesBatchUpsert**](docs/BatchAPI.md#postcrmv3objectsfeesbatchupsert) | **Post** /crm/v3/objects/fees/batch/upsert | Create or update a batch of fees by unique property values
*SearchAPI* | [**PostCrmV3ObjectsFeesSearch**](docs/SearchAPI.md#postcrmv3objectsfeessearch) | **Post** /crm/v3/objects/fees/search | 
...
```go
auth := context.WithValue(context.Background(), fees.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, fees.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
