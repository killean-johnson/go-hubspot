# Go API client for communications
...
```go
import communications "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `communications.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), communications.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `communications.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), communications.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `communications.ContextOperationServerIndices` and `communications.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), communications.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), communications.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsCommunicationsCommunicationIdArchive**](docs/BasicAPI.md#deletecrmv3objectscommunicationscommunicationidarchive) | **Delete** /crm/v3/objects/communications/{communicationId} | Archive
*BasicAPI* | [**GetCrmV3ObjectsCommunicationsCommunicationIdGetById**](docs/BasicAPI.md#getcrmv3objectscommunicationscommunicationidgetbyid) | **Get** /crm/v3/objects/communications/{communicationId} | Read
*BasicAPI* | [**GetCrmV3ObjectsCommunicationsGetPage**](docs/BasicAPI.md#getcrmv3objectscommunicationsgetpage) | **Get** /crm/v3/objects/communications | List
*BasicAPI* | [**PatchCrmV3ObjectsCommunicationsCommunicationIdUpdate**](docs/BasicAPI.md#patchcrmv3objectscommunicationscommunicationidupdate) | **Patch** /crm/v3/objects/communications/{communicationId} | Update
*BasicAPI* | [**PostCrmV3ObjectsCommunicationsCreate**](docs/BasicAPI.md#postcrmv3objectscommunicationscreate) | **Post** /crm/v3/objects/communications | Create
*BatchAPI* | [**PostCrmV3ObjectsCommunicationsBatchArchiveArchive**](docs/BatchAPI.md#postcrmv3objectscommunicationsbatcharchivearchive) | **Post** /crm/v3/objects/communications/batch/archive | Archive a batch of communications by ID
*BatchAPI* | [**PostCrmV3ObjectsCommunicationsBatchCreateCreate**](docs/BatchAPI.md#postcrmv3objectscommunicationsbatchcreatecreate) | **Post** /crm/v3/objects/communications/batch/create | Create a batch of communications
*BatchAPI* | [**PostCrmV3ObjectsCommunicationsBatchReadRead**](docs/BatchAPI.md#postcrmv3objectscommunicationsbatchreadread) | **Post** /crm/v3/objects/communications/batch/read | Read a batch of communications by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsCommunicationsBatchUpdateUpdate**](docs/BatchAPI.md#postcrmv3objectscommunicationsbatchupdateupdate) | **Post** /crm/v3/objects/communications/batch/update | Update a batch of communications by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsCommunicationsBatchUpsertUpsert**](docs/BatchAPI.md#postcrmv3objectscommunicationsbatchupsertupsert) | **Post** /crm/v3/objects/communications/batch/upsert | Create or update a batch of communications by unique property values
*SearchAPI* | [**PostCrmV3ObjectsCommunicationsSearchDoSearch**](docs/SearchAPI.md#postcrmv3objectscommunicationssearchdosearch) | **Post** /crm/v3/objects/communications/search | Search for messages
...
```go
auth := context.WithValue(context.Background(), communications.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, communications.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		communications.ContextAPIKeys,
		map[string]communications.APIKey{
