...
```go
import leads "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `leads.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), leads.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `leads.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), leads.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `leads.ContextOperationServerIndices` and `leads.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), leads.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), leads.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsLeadsLeadsIdArchive**](docs/BasicAPI.md#deletecrmv3objectsleadsleadsidarchive) | **Delete** /crm/v3/objects/leads/{leadsId} | Archive
*BasicAPI* | [**GetCrmV3ObjectsLeadsGetPage**](docs/BasicAPI.md#getcrmv3objectsleadsgetpage) | **Get** /crm/v3/objects/leads | List
*BasicAPI* | [**GetCrmV3ObjectsLeadsLeadsIdGetById**](docs/BasicAPI.md#getcrmv3objectsleadsleadsidgetbyid) | **Get** /crm/v3/objects/leads/{leadsId} | Read
*BasicAPI* | [**PatchCrmV3ObjectsLeadsLeadsIdUpdate**](docs/BasicAPI.md#patchcrmv3objectsleadsleadsidupdate) | **Patch** /crm/v3/objects/leads/{leadsId} | Update
*BasicAPI* | [**PostCrmV3ObjectsLeadsCreate**](docs/BasicAPI.md#postcrmv3objectsleadscreate) | **Post** /crm/v3/objects/leads | Create
*BatchAPI* | [**PostCrmV3ObjectsLeadsBatchArchiveArchive**](docs/BatchAPI.md#postcrmv3objectsleadsbatcharchivearchive) | **Post** /crm/v3/objects/leads/batch/archive | Archive a batch of leads by ID
*BatchAPI* | [**PostCrmV3ObjectsLeadsBatchCreateCreate**](docs/BatchAPI.md#postcrmv3objectsleadsbatchcreatecreate) | **Post** /crm/v3/objects/leads/batch/create | Create a batch of leads
*BatchAPI* | [**PostCrmV3ObjectsLeadsBatchReadRead**](docs/BatchAPI.md#postcrmv3objectsleadsbatchreadread) | **Post** /crm/v3/objects/leads/batch/read | Read a batch of leads by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsLeadsBatchUpdateUpdate**](docs/BatchAPI.md#postcrmv3objectsleadsbatchupdateupdate) | **Post** /crm/v3/objects/leads/batch/update | Update a batch of leads by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsLeadsBatchUpsertUpsert**](docs/BatchAPI.md#postcrmv3objectsleadsbatchupsertupsert) | **Post** /crm/v3/objects/leads/batch/upsert | Create or update a batch of leads by unique property values
*SearchAPI* | [**PostCrmV3ObjectsLeadsSearchDoSearch**](docs/SearchAPI.md#postcrmv3objectsleadssearchdosearch) | **Post** /crm/v3/objects/leads/search | 
...
```go
auth := context.WithValue(context.Background(), leads.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, leads.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		leads.ContextAPIKeys,
		map[string]leads.APIKey{
