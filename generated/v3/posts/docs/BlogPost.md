...
**Language** | **string** | The explicitly defined ISO 639 language code of the post. If null, the post will default to the language of the parent blog. | 
...
**State** | **string** | An enumeration describing the current publish state of the post. | 
**Slug** | **string** | The URL slug of the blog post. This field is appended to the domain to construct the url of this post. | 
**CreatedById** | **string** | The ID of the user that created the post. | 
...
**UpdatedById** | **string** | The ID of the user that updated the post. | 
**TranslatedFromId** | **string** | ID of the primary blog post that this post was translated from. | 
**FolderId** | **string** |  | 
...
**AuthorName** | **string** | The name of the blog author associated with the post. | 
**Domain** | **string** | The domain that the post lives on. If null, the post will default to the domain of the parent blog. | 
**Name** | **string** | The internal name of the post. | 
**DynamicPageHubDbTableId** | **string** | For dynamic HubDB pages,  the ID of the HubDB table this post references. | 
**Campaign** | **string** | The GUID of the marketing campaign the post is associated with. | 
...
**TagIds** | **[]int64** | The IDs of the tags associated with this post. | 
