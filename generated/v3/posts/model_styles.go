...
type Styles struct {
	...
	BreakpointStyles *map[string]BreakpointStyles `json:"breakpointStyles,omitempty"`
...
// GetBreakpointStyles returns the BreakpointStyles field value if set, zero value otherwise.
func (o *Styles) GetBreakpointStyles() map[string]BreakpointStyles {
	if o == nil || IsNil(o.BreakpointStyles) {
		var ret map[string]BreakpointStyles
		return ret
	}
	return *o.BreakpointStyles
}

// GetBreakpointStylesOk returns a tuple with the BreakpointStyles field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Styles) GetBreakpointStylesOk() (*map[string]BreakpointStyles, bool) {
	if o == nil || IsNil(o.BreakpointStyles) {
		return nil, false
	}
	return o.BreakpointStyles, true
}
...
// SetBreakpointStyles gets a reference to the given map[string]BreakpointStyles and assigns it to the BreakpointStyles field.
func (o *Styles) SetBreakpointStyles(v map[string]BreakpointStyles) {
	o.BreakpointStyles = &v
}
...
func (o Styles) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BreakpointStyles) {
		toSerialize["breakpointStyles"] = o.BreakpointStyles
	}
