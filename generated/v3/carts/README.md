...
```go
import carts "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `carts.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), carts.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `carts.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), carts.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `carts.ContextOperationServerIndices` and `carts.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), carts.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), carts.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsCartsCartId**](docs/BasicAPI.md#deletecrmv3objectscartscartid) | **Delete** /crm/v3/objects/carts/{cartId} | Archive a cart
*BasicAPI* | [**GetCrmV3ObjectsCarts**](docs/BasicAPI.md#getcrmv3objectscarts) | **Get** /crm/v3/objects/carts | Retrieve carts
*BasicAPI* | [**GetCrmV3ObjectsCartsCartId**](docs/BasicAPI.md#getcrmv3objectscartscartid) | **Get** /crm/v3/objects/carts/{cartId} | Retrieve a cart
*BasicAPI* | [**PatchCrmV3ObjectsCartsCartId**](docs/BasicAPI.md#patchcrmv3objectscartscartid) | **Patch** /crm/v3/objects/carts/{cartId} | Update a cart
*BasicAPI* | [**PostCrmV3ObjectsCarts**](docs/BasicAPI.md#postcrmv3objectscarts) | **Post** /crm/v3/objects/carts | Create a cart
*BatchAPI* | [**PostCrmV3ObjectsCartsBatchArchive**](docs/BatchAPI.md#postcrmv3objectscartsbatcharchive) | **Post** /crm/v3/objects/carts/batch/archive | Archive a batch of carts
*BatchAPI* | [**PostCrmV3ObjectsCartsBatchCreate**](docs/BatchAPI.md#postcrmv3objectscartsbatchcreate) | **Post** /crm/v3/objects/carts/batch/create | Create a batch of carts
*BatchAPI* | [**PostCrmV3ObjectsCartsBatchRead**](docs/BatchAPI.md#postcrmv3objectscartsbatchread) | **Post** /crm/v3/objects/carts/batch/read | Retrieve a batch of carts 
*BatchAPI* | [**PostCrmV3ObjectsCartsBatchUpdate**](docs/BatchAPI.md#postcrmv3objectscartsbatchupdate) | **Post** /crm/v3/objects/carts/batch/update | Update a batch of carts
*BatchAPI* | [**PostCrmV3ObjectsCartsBatchUpsert**](docs/BatchAPI.md#postcrmv3objectscartsbatchupsert) | **Post** /crm/v3/objects/carts/batch/upsert | Create and update a batch of carts by unique property
*SearchAPI* | [**PostCrmV3ObjectsCartsSearch**](docs/SearchAPI.md#postcrmv3objectscartssearch) | **Post** /crm/v3/objects/carts/search | Search for carts
...
```go
auth := context.WithValue(context.Background(), carts.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, carts.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		carts.ContextAPIKeys,
		map[string]carts.APIKey{
