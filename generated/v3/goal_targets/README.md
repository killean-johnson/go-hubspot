# Go API client for goal_targets
...
```go
import goal_targets "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `goal_targets.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), goal_targets.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `goal_targets.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), goal_targets.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `goal_targets.ContextOperationServerIndices` and `goal_targets.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), goal_targets.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), goal_targets.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsGoalTargetsGoalTargetIdArchive**](docs/BasicAPI.md#deletecrmv3objectsgoaltargetsgoaltargetidarchive) | **Delete** /crm/v3/objects/goal_targets/{goalTargetId} | Archive
*BasicAPI* | [**GetCrmV3ObjectsGoalTargetsGetPage**](docs/BasicAPI.md#getcrmv3objectsgoaltargetsgetpage) | **Get** /crm/v3/objects/goal_targets | List
*BasicAPI* | [**GetCrmV3ObjectsGoalTargetsGoalTargetIdGetById**](docs/BasicAPI.md#getcrmv3objectsgoaltargetsgoaltargetidgetbyid) | **Get** /crm/v3/objects/goal_targets/{goalTargetId} | Read
*BasicAPI* | [**PatchCrmV3ObjectsGoalTargetsGoalTargetIdUpdate**](docs/BasicAPI.md#patchcrmv3objectsgoaltargetsgoaltargetidupdate) | **Patch** /crm/v3/objects/goal_targets/{goalTargetId} | Update
*BasicAPI* | [**PostCrmV3ObjectsGoalTargetsCreate**](docs/BasicAPI.md#postcrmv3objectsgoaltargetscreate) | **Post** /crm/v3/objects/goal_targets | Create
*BatchAPI* | [**PostCrmV3ObjectsGoalTargetsBatchArchiveArchive**](docs/BatchAPI.md#postcrmv3objectsgoaltargetsbatcharchivearchive) | **Post** /crm/v3/objects/goal_targets/batch/archive | Archive a batch of goal targets by ID
*BatchAPI* | [**PostCrmV3ObjectsGoalTargetsBatchCreateCreate**](docs/BatchAPI.md#postcrmv3objectsgoaltargetsbatchcreatecreate) | **Post** /crm/v3/objects/goal_targets/batch/create | Create a batch of goal targets
*BatchAPI* | [**PostCrmV3ObjectsGoalTargetsBatchReadRead**](docs/BatchAPI.md#postcrmv3objectsgoaltargetsbatchreadread) | **Post** /crm/v3/objects/goal_targets/batch/read | Read a batch of goal targets by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsGoalTargetsBatchUpdateUpdate**](docs/BatchAPI.md#postcrmv3objectsgoaltargetsbatchupdateupdate) | **Post** /crm/v3/objects/goal_targets/batch/update | Update a batch of goal targets by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsGoalTargetsBatchUpsertUpsert**](docs/BatchAPI.md#postcrmv3objectsgoaltargetsbatchupsertupsert) | **Post** /crm/v3/objects/goal_targets/batch/upsert | Create or update a batch of goal targets by unique property values
*SearchAPI* | [**PostCrmV3ObjectsGoalTargetsSearchDoSearch**](docs/SearchAPI.md#postcrmv3objectsgoaltargetssearchdosearch) | **Post** /crm/v3/objects/goal_targets/search | 
...
```go
auth := context.WithValue(context.Background(), goal_targets.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, goal_targets.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		goal_targets.ContextAPIKeys,
		map[string]goal_targets.APIKey{
