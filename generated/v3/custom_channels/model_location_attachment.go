...
// checks if the LocationAttachment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocationAttachment{}

// LocationAttachment struct for LocationAttachment
...
type _LocationAttachment LocationAttachment
...
func (o LocationAttachment) MarshalJSON() ([]byte, error) {
...
func (o LocationAttachment) ToMap() (map[string]interface{}, error) {
...
func (o *LocationAttachment) UnmarshalJSON(data []byte) (err error) {
	...
	varLocationAttachment := _LocationAttachment{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLocationAttachment)

	if err != nil {
		return err
	}

	*o = LocationAttachment(varLocationAttachment)

	return err
}

type NullableLocationAttachment struct {
	value *LocationAttachment
	isSet bool
}

func (v NullableLocationAttachment) Get() *LocationAttachment {
	return v.value
}

func (v *NullableLocationAttachment) Set(val *LocationAttachment) {
	v.value = val
	v.isSet = true
}

func (v NullableLocationAttachment) IsSet() bool {
	return v.isSet
}

func (v *NullableLocationAttachment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocationAttachment(val *LocationAttachment) *NullableLocationAttachment {
	return &NullableLocationAttachment{value: val, isSet: true}
}

func (v NullableLocationAttachment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocationAttachment) UnmarshalJSON(src []byte) error {
	v.isSet = true
