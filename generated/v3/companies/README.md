...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsCompaniesCompanyIdArchive**](docs/BasicAPI.md#deletecrmv3objectscompaniescompanyidarchive) | **Delete** /crm/v3/objects/companies/{companyId} | Archive a company
*BasicAPI* | [**GetCrmV3ObjectsCompaniesCompanyIdGetById**](docs/BasicAPI.md#getcrmv3objectscompaniescompanyidgetbyid) | **Get** /crm/v3/objects/companies/{companyId} | Retrieve a company
*BasicAPI* | [**GetCrmV3ObjectsCompaniesGetPage**](docs/BasicAPI.md#getcrmv3objectscompaniesgetpage) | **Get** /crm/v3/objects/companies | Retrieve companies
*BasicAPI* | [**PatchCrmV3ObjectsCompaniesCompanyIdUpdate**](docs/BasicAPI.md#patchcrmv3objectscompaniescompanyidupdate) | **Patch** /crm/v3/objects/companies/{companyId} | Update a company
*BasicAPI* | [**PostCrmV3ObjectsCompaniesCreate**](docs/BasicAPI.md#postcrmv3objectscompaniescreate) | **Post** /crm/v3/objects/companies | Create a company
*BasicAPI* | [**PostCrmV3ObjectsCompaniesMergeMerge**](docs/BasicAPI.md#postcrmv3objectscompaniesmergemerge) | **Post** /crm/v3/objects/companies/merge | Merge two companies
*BatchAPI* | [**PostCrmV3ObjectsCompaniesBatchArchiveArchive**](docs/BatchAPI.md#postcrmv3objectscompaniesbatcharchivearchive) | **Post** /crm/v3/objects/companies/batch/archive | Archive a batch of companies
...
*BatchAPI* | [**PostCrmV3ObjectsCompaniesBatchReadRead**](docs/BatchAPI.md#postcrmv3objectscompaniesbatchreadread) | **Post** /crm/v3/objects/companies/batch/read | Retrieve a batch of companies
...
*BatchAPI* | [**PostCrmV3ObjectsCompaniesBatchUpsertUpsert**](docs/BatchAPI.md#postcrmv3objectscompaniesbatchupsertupsert) | **Post** /crm/v3/objects/companies/batch/upsert | Create or update a batch of companies by unique property values
*SearchAPI* | [**PostCrmV3ObjectsCompaniesSearchDoSearch**](docs/SearchAPI.md#postcrmv3objectscompaniessearchdosearch) | **Post** /crm/v3/objects/companies/search | Search for companies
