...
```go
import taxes "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `taxes.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), taxes.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `taxes.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), taxes.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `taxes.ContextOperationServerIndices` and `taxes.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), taxes.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), taxes.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsTaxesTaxIdArchive**](docs/BasicAPI.md#deletecrmv3objectstaxestaxidarchive) | **Delete** /crm/v3/objects/taxes/{taxId} | Archive
*BasicAPI* | [**GetCrmV3ObjectsTaxesGetPage**](docs/BasicAPI.md#getcrmv3objectstaxesgetpage) | **Get** /crm/v3/objects/taxes | List
*BasicAPI* | [**GetCrmV3ObjectsTaxesTaxIdGetById**](docs/BasicAPI.md#getcrmv3objectstaxestaxidgetbyid) | **Get** /crm/v3/objects/taxes/{taxId} | Read
*BasicAPI* | [**PatchCrmV3ObjectsTaxesTaxIdUpdate**](docs/BasicAPI.md#patchcrmv3objectstaxestaxidupdate) | **Patch** /crm/v3/objects/taxes/{taxId} | Update
*BasicAPI* | [**PostCrmV3ObjectsTaxesCreate**](docs/BasicAPI.md#postcrmv3objectstaxescreate) | **Post** /crm/v3/objects/taxes | Create
*BatchAPI* | [**PostCrmV3ObjectsTaxesBatchArchiveArchive**](docs/BatchAPI.md#postcrmv3objectstaxesbatcharchivearchive) | **Post** /crm/v3/objects/taxes/batch/archive | Archive a batch of taxes by ID
*BatchAPI* | [**PostCrmV3ObjectsTaxesBatchCreateCreate**](docs/BatchAPI.md#postcrmv3objectstaxesbatchcreatecreate) | **Post** /crm/v3/objects/taxes/batch/create | Create a batch of taxes
*BatchAPI* | [**PostCrmV3ObjectsTaxesBatchReadRead**](docs/BatchAPI.md#postcrmv3objectstaxesbatchreadread) | **Post** /crm/v3/objects/taxes/batch/read | Read a batch of taxes by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsTaxesBatchUpdateUpdate**](docs/BatchAPI.md#postcrmv3objectstaxesbatchupdateupdate) | **Post** /crm/v3/objects/taxes/batch/update | Update a batch of taxes by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsTaxesBatchUpsertUpsert**](docs/BatchAPI.md#postcrmv3objectstaxesbatchupsertupsert) | **Post** /crm/v3/objects/taxes/batch/upsert | Create or update a batch of taxes by unique property values
*SearchAPI* | [**PostCrmV3ObjectsTaxesSearchDoSearch**](docs/SearchAPI.md#postcrmv3objectstaxessearchdosearch) | **Post** /crm/v3/objects/taxes/search | 
...
```go
auth := context.WithValue(context.Background(), taxes.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, taxes.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		taxes.ContextAPIKeys,
		map[string]taxes.APIKey{
