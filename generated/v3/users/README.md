...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsUsersUserId**](docs/BasicAPI.md#deletecrmv3objectsusersuserid) | **Delete** /crm/v3/objects/users/{userId} | Archive
*BasicAPI* | [**GetCrmV3ObjectsUsers**](docs/BasicAPI.md#getcrmv3objectsusers) | **Get** /crm/v3/objects/users | List
*BasicAPI* | [**GetCrmV3ObjectsUsersUserId**](docs/BasicAPI.md#getcrmv3objectsusersuserid) | **Get** /crm/v3/objects/users/{userId} | Read
*BasicAPI* | [**PatchCrmV3ObjectsUsersUserId**](docs/BasicAPI.md#patchcrmv3objectsusersuserid) | **Patch** /crm/v3/objects/users/{userId} | Update
*BasicAPI* | [**PostCrmV3ObjectsUsers**](docs/BasicAPI.md#postcrmv3objectsusers) | **Post** /crm/v3/objects/users | Create
*BatchAPI* | [**PostCrmV3ObjectsUsersBatchArchive**](docs/BatchAPI.md#postcrmv3objectsusersbatcharchive) | **Post** /crm/v3/objects/users/batch/archive | Archive a batch of users by ID
*BatchAPI* | [**PostCrmV3ObjectsUsersBatchCreate**](docs/BatchAPI.md#postcrmv3objectsusersbatchcreate) | **Post** /crm/v3/objects/users/batch/create | Create a batch of users
*BatchAPI* | [**PostCrmV3ObjectsUsersBatchRead**](docs/BatchAPI.md#postcrmv3objectsusersbatchread) | **Post** /crm/v3/objects/users/batch/read | Read a batch of users by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsUsersBatchUpdate**](docs/BatchAPI.md#postcrmv3objectsusersbatchupdate) | **Post** /crm/v3/objects/users/batch/update | Update a batch of users by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsUsersBatchUpsert**](docs/BatchAPI.md#postcrmv3objectsusersbatchupsert) | **Post** /crm/v3/objects/users/batch/upsert | Create or update a batch of users by unique property values
*SearchAPI* | [**PostCrmV3ObjectsUsersSearch**](docs/SearchAPI.md#postcrmv3objectsuserssearch) | **Post** /crm/v3/objects/users/search | 
...
```go
auth := context.WithValue(context.Background(), users.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, users.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		users.ContextAPIKeys,
		map[string]users.APIKey{
