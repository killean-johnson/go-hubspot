...
// checks if the PublicThreadStatusChange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicThreadStatusChange{}

// PublicThreadStatusChange struct for PublicThreadStatusChange
...
type _PublicThreadStatusChange PublicThreadStatusChange
...
func NewPublicThreadStatusChangeWithDefaults() *PublicThreadStatusChange {
	this := PublicThreadStatusChange{}
	var type_ string = "THREAD_STATUS_CHANGE"
	this.Type = type_
	return &this
}
...
func (o PublicThreadStatusChange) MarshalJSON() ([]byte, error) {
...
func (o PublicThreadStatusChange) ToMap() (map[string]interface{}, error) {
...
func (o *PublicThreadStatusChange) UnmarshalJSON(data []byte) (err error) {
	...
	varPublicThreadStatusChange := _PublicThreadStatusChange{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPublicThreadStatusChange)

	if err != nil {
		return err
	}

	*o = PublicThreadStatusChange(varPublicThreadStatusChange)

	return err
}

type NullablePublicThreadStatusChange struct {
	value *PublicThreadStatusChange
	isSet bool
}

func (v NullablePublicThreadStatusChange) Get() *PublicThreadStatusChange {
	return v.value
}

func (v *NullablePublicThreadStatusChange) Set(val *PublicThreadStatusChange) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicThreadStatusChange) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicThreadStatusChange) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicThreadStatusChange(val *PublicThreadStatusChange) *NullablePublicThreadStatusChange {
	return &NullablePublicThreadStatusChange{value: val, isSet: true}
}

func (v NullablePublicThreadStatusChange) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicThreadStatusChange) UnmarshalJSON(src []byte) error {
	v.isSet = true
