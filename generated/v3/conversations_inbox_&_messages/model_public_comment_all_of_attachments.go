...
// PublicCommentAllOfAttachments - struct for PublicCommentAllOfAttachments
type PublicCommentAllOfAttachments struct {
...
// PublicContactAsPublicCommentAllOfAttachments is a convenience function that returns PublicContact wrapped in PublicCommentAllOfAttachments
func PublicContactAsPublicCommentAllOfAttachments(v *PublicContact) PublicCommentAllOfAttachments {
	return PublicCommentAllOfAttachments{
		PublicContact: v,
	}
}

// PublicFileAsPublicCommentAllOfAttachments is a convenience function that returns PublicFile wrapped in PublicCommentAllOfAttachments
func PublicFileAsPublicCommentAllOfAttachments(v *PublicFile) PublicCommentAllOfAttachments {
	return PublicCommentAllOfAttachments{
		PublicFile: v,
	}
}

// PublicLocationAsPublicCommentAllOfAttachments is a convenience function that returns PublicLocation wrapped in PublicCommentAllOfAttachments
func PublicLocationAsPublicCommentAllOfAttachments(v *PublicLocation) PublicCommentAllOfAttachments {
	return PublicCommentAllOfAttachments{
		PublicLocation: v,
	}
}

// PublicMessageHeaderAsPublicCommentAllOfAttachments is a convenience function that returns PublicMessageHeader wrapped in PublicCommentAllOfAttachments
func PublicMessageHeaderAsPublicCommentAllOfAttachments(v *PublicMessageHeader) PublicCommentAllOfAttachments {
	return PublicCommentAllOfAttachments{
		PublicMessageHeader: v,
	}
}

// PublicQuickRepliesAsPublicCommentAllOfAttachments is a convenience function that returns PublicQuickReplies wrapped in PublicCommentAllOfAttachments
func PublicQuickRepliesAsPublicCommentAllOfAttachments(v *PublicQuickReplies) PublicCommentAllOfAttachments {
	return PublicCommentAllOfAttachments{
		PublicQuickReplies: v,
	}
}

// PublicUnsupportedContentAsPublicCommentAllOfAttachments is a convenience function that returns PublicUnsupportedContent wrapped in PublicCommentAllOfAttachments
func PublicUnsupportedContentAsPublicCommentAllOfAttachments(v *PublicUnsupportedContent) PublicCommentAllOfAttachments {
	return PublicCommentAllOfAttachments{
		PublicUnsupportedContent: v,
	}
}

// PublicWhatsAppTemplateMetadataAsPublicCommentAllOfAttachments is a convenience function that returns PublicWhatsAppTemplateMetadata wrapped in PublicCommentAllOfAttachments
func PublicWhatsAppTemplateMetadataAsPublicCommentAllOfAttachments(v *PublicWhatsAppTemplateMetadata) PublicCommentAllOfAttachments {
	return PublicCommentAllOfAttachments{
...
func (dst *PublicCommentAllOfAttachments) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(PublicCommentAllOfAttachments)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(PublicCommentAllOfAttachments)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src PublicCommentAllOfAttachments) MarshalJSON() ([]byte, error) {
...
func (obj *PublicCommentAllOfAttachments) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
func (obj PublicCommentAllOfAttachments) GetActualInstanceValue() (interface{}) {
	if obj.PublicContact != nil {
		return *obj.PublicContact
	}
...
type NullablePublicCommentAllOfAttachments struct {
	value *PublicCommentAllOfAttachments
	isSet bool
}

func (v NullablePublicCommentAllOfAttachments) Get() *PublicCommentAllOfAttachments {
	return v.value
}

func (v *NullablePublicCommentAllOfAttachments) Set(val *PublicCommentAllOfAttachments) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicCommentAllOfAttachments) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicCommentAllOfAttachments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicCommentAllOfAttachments(val *PublicCommentAllOfAttachments) *NullablePublicCommentAllOfAttachments {
	return &NullablePublicCommentAllOfAttachments{value: val, isSet: true}
}

func (v NullablePublicCommentAllOfAttachments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicCommentAllOfAttachments) UnmarshalJSON(src []byte) error {
	v.isSet = true
