...
// checks if the PublicThreadInboxChange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicThreadInboxChange{}

// PublicThreadInboxChange struct for PublicThreadInboxChange
...
type _PublicThreadInboxChange PublicThreadInboxChange
...
func NewPublicThreadInboxChangeWithDefaults() *PublicThreadInboxChange {
	this := PublicThreadInboxChange{}
	var type_ string = "THREAD_INBOX_CHANGE"
	this.Type = type_
	return &this
}
...
func (o PublicThreadInboxChange) MarshalJSON() ([]byte, error) {
...
func (o PublicThreadInboxChange) ToMap() (map[string]interface{}, error) {
...
func (o *PublicThreadInboxChange) UnmarshalJSON(data []byte) (err error) {
	...
	varPublicThreadInboxChange := _PublicThreadInboxChange{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPublicThreadInboxChange)

	if err != nil {
		return err
	}

	*o = PublicThreadInboxChange(varPublicThreadInboxChange)

	return err
}

type NullablePublicThreadInboxChange struct {
	value *PublicThreadInboxChange
	isSet bool
}

func (v NullablePublicThreadInboxChange) Get() *PublicThreadInboxChange {
	return v.value
}

func (v *NullablePublicThreadInboxChange) Set(val *PublicThreadInboxChange) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicThreadInboxChange) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicThreadInboxChange) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicThreadInboxChange(val *PublicThreadInboxChange) *NullablePublicThreadInboxChange {
	return &NullablePublicThreadInboxChange{value: val, isSet: true}
}

func (v NullablePublicThreadInboxChange) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicThreadInboxChange) UnmarshalJSON(src []byte) error {
	v.isSet = true
