...
func (a *EventsAPIService) GetIntegratorsTimelineV3EventsEventTemplateIdEventIdDetailGetDetailByIdExecute(r ApiGetIntegratorsTimelineV3EventsEventTemplateIdEventIdDetailGetDetailByIdRequest) (*EventDetail, *http.Response, error) {
	...
	localVarPath := localBasePath + "/integrators/timeline/v3/events/{eventTemplateId}/{eventId}/detail"
...
func (a *EventsAPIService) GetIntegratorsTimelineV3EventsEventTemplateIdEventIdGetByIdExecute(r ApiGetIntegratorsTimelineV3EventsEventTemplateIdEventIdGetByIdRequest) (*TimelineEventResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/integrators/timeline/v3/events/{eventTemplateId}/{eventId}"
	localVarPath = strings.Replace(localVarPath, "{"+"eventTemplateId"+"}", url.PathEscape(parameterValueToString(r.eventTemplateId, "eventTemplateId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"eventId"+"}", url.PathEscape(parameterValueToString(r.eventId, "eventId")), -1)
...
func (a *EventsAPIService) GetIntegratorsTimelineV3EventsEventTemplateIdEventIdRenderGetRenderByIdExecute(r ApiGetIntegratorsTimelineV3EventsEventTemplateIdEventIdRenderGetRenderByIdRequest) (string, *http.Response, error) {
	...
	localVarPath := localBasePath + "/integrators/timeline/v3/events/{eventTemplateId}/{eventId}/render"
	localVarPath = strings.Replace(localVarPath, "{"+"eventTemplateId"+"}", url.PathEscape(parameterValueToString(r.eventTemplateId, "eventTemplateId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"eventId"+"}", url.PathEscape(parameterValueToString(r.eventId, "eventId")), -1)
...
func (r ApiPostIntegratorsTimelineV3EventsBatchCreateCreateBatchRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *EventsAPIService) PostIntegratorsTimelineV3EventsBatchCreateCreateBatchExecute(r ApiPostIntegratorsTimelineV3EventsBatchCreateCreateBatchRequest) (*http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/integrators/timeline/v3/events/batch/create"
...
func (a *EventsAPIService) PostIntegratorsTimelineV3EventsCreateExecute(r ApiPostIntegratorsTimelineV3EventsCreateRequest) (*TimelineEventResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/integrators/timeline/v3/events"
