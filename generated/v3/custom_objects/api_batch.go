...
type ApiPostCrmV3ObjectsObjectTypeBatchUpsertRequest struct {
	ctx context.Context
	ApiService *BatchAPIService
	objectType string
...
func (r ApiPostCrmV3ObjectsObjectTypeBatchUpsertRequest) BatchInputSimplePublicObjectBatchInputUpsert(batchInputSimplePublicObjectBatchInputUpsert BatchInputSimplePublicObjectBatchInputUpsert) ApiPostCrmV3ObjectsObjectTypeBatchUpsertRequest {
	r.batchInputSimplePublicObjectBatchInputUpsert = &batchInputSimplePublicObjectBatchInputUpsert
	return r
}

func (r ApiPostCrmV3ObjectsObjectTypeBatchUpsertRequest) Execute() (*BatchResponseSimplePublicUpsertObject, *http.Response, error) {
	return r.ApiService.PostCrmV3ObjectsObjectTypeBatchUpsertExecute(r)
}

/*
PostCrmV3ObjectsObjectTypeBatchUpsert Create or update a batch of objects by unique property values

Create or update records identified by a unique property value as specified by the `idProperty` query param. `idProperty` query param refers to a property whose values are unique for the object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param objectType
 @return ApiPostCrmV3ObjectsObjectTypeBatchUpsertRequest
*/
func (a *BatchAPIService) PostCrmV3ObjectsObjectTypeBatchUpsert(ctx context.Context, objectType string) ApiPostCrmV3ObjectsObjectTypeBatchUpsertRequest {
	return ApiPostCrmV3ObjectsObjectTypeBatchUpsertRequest{
		ApiService: a,
		ctx: ctx,
		objectType: objectType,
...
func (a *BatchAPIService) PostCrmV3ObjectsObjectTypeBatchUpsertExecute(r ApiPostCrmV3ObjectsObjectTypeBatchUpsertRequest) (*BatchResponseSimplePublicUpsertObject, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BatchAPIService.PostCrmV3ObjectsObjectTypeBatchUpsert")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
