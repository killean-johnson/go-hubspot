...
*/
func (a *BasicAPIService) PostCrmV3ObjectsObjectTypeMergeMerge(ctx context.Context, objectType string) ApiPostCrmV3ObjectsObjectTypeMergeMergeRequest {
	return ApiPostCrmV3ObjectsObjectTypeMergeMergeRequest{
		ApiService: a,
		ctx: ctx,
		objectType: objectType,
...
// Execute executes the request
//  @return SimplePublicObject
func (a *BasicAPIService) PostCrmV3ObjectsObjectTypeMergeMergeExecute(r ApiPostCrmV3ObjectsObjectTypeMergeMergeRequest) (*SimplePublicObject, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BasicAPIService.PostCrmV3ObjectsObjectTypeMergeMerge")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
