...
type PublicEmailContent struct {
	...
	StyleSettings *PublicEmailStyleSettings `json:"styleSettings,omitempty"`
}
...
func (o *PublicEmailContent) GetStyleSettings() PublicEmailStyleSettings {
	if o == nil || IsNil(o.StyleSettings) {
		var ret PublicEmailStyleSettings
		return ret
	}
...
// SetStyleSettings gets a reference to the given PublicEmailStyleSettings and assigns it to the StyleSettings field.
