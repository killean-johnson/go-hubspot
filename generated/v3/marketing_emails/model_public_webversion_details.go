...
// GetIsPageRedirected returns the IsPageRedirected field value if set, zero value otherwise.
func (o *PublicWebversionDetails) GetIsPageRedirected() bool {
	if o == nil || IsNil(o.IsPageRedirected) {
		var ret bool
		return ret
	}
	return *o.IsPageRedirected
}

// GetIsPageRedirectedOk returns a tuple with the IsPageRedirected field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PublicWebversionDetails) GetIsPageRedirectedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPageRedirected) {
		return nil, false
	}
	return o.IsPageRedirected, true
}
...
// SetIsPageRedirected gets a reference to the given bool and assigns it to the IsPageRedirected field.
func (o *PublicWebversionDetails) SetIsPageRedirected(v bool) {
	o.IsPageRedirected = &v
}
...
// GetPageExpiryEnabled returns the PageExpiryEnabled field value if set, zero value otherwise.
func (o *PublicWebversionDetails) GetPageExpiryEnabled() bool {
	if o == nil || IsNil(o.PageExpiryEnabled) {
		var ret bool
		return ret
	}
...
// GetPageExpiryEnabledOk returns a tuple with the PageExpiryEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetPageExpiryEnabled gets a reference to the given bool and assigns it to the PageExpiryEnabled field.
...
func (o PublicWebversionDetails) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsPageRedirected) {
		toSerialize["isPageRedirected"] = o.IsPageRedirected
	}
