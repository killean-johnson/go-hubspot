...
```go
import invoices "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `invoices.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), invoices.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `invoices.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), invoices.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `invoices.ContextOperationServerIndices` and `invoices.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), invoices.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), invoices.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsInvoicesInvoiceIdArchive**](docs/BasicAPI.md#deletecrmv3objectsinvoicesinvoiceidarchive) | **Delete** /crm/v3/objects/invoices/{invoiceId} | Archive
*BasicAPI* | [**GetCrmV3ObjectsInvoicesGetPage**](docs/BasicAPI.md#getcrmv3objectsinvoicesgetpage) | **Get** /crm/v3/objects/invoices | List
*BasicAPI* | [**GetCrmV3ObjectsInvoicesInvoiceIdGetById**](docs/BasicAPI.md#getcrmv3objectsinvoicesinvoiceidgetbyid) | **Get** /crm/v3/objects/invoices/{invoiceId} | Read
*BasicAPI* | [**PatchCrmV3ObjectsInvoicesInvoiceIdUpdate**](docs/BasicAPI.md#patchcrmv3objectsinvoicesinvoiceidupdate) | **Patch** /crm/v3/objects/invoices/{invoiceId} | Update
*BasicAPI* | [**PostCrmV3ObjectsInvoicesCreate**](docs/BasicAPI.md#postcrmv3objectsinvoicescreate) | **Post** /crm/v3/objects/invoices | Create
*BatchAPI* | [**PostCrmV3ObjectsInvoicesBatchArchiveArchive**](docs/BatchAPI.md#postcrmv3objectsinvoicesbatcharchivearchive) | **Post** /crm/v3/objects/invoices/batch/archive | Archive a batch of invoices by ID
*BatchAPI* | [**PostCrmV3ObjectsInvoicesBatchCreateCreate**](docs/BatchAPI.md#postcrmv3objectsinvoicesbatchcreatecreate) | **Post** /crm/v3/objects/invoices/batch/create | Create a batch of invoices
*BatchAPI* | [**PostCrmV3ObjectsInvoicesBatchReadRead**](docs/BatchAPI.md#postcrmv3objectsinvoicesbatchreadread) | **Post** /crm/v3/objects/invoices/batch/read | Read a batch of invoices by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsInvoicesBatchUpdateUpdate**](docs/BatchAPI.md#postcrmv3objectsinvoicesbatchupdateupdate) | **Post** /crm/v3/objects/invoices/batch/update | Update a batch of invoices by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsInvoicesBatchUpsertUpsert**](docs/BatchAPI.md#postcrmv3objectsinvoicesbatchupsertupsert) | **Post** /crm/v3/objects/invoices/batch/upsert | Create or update a batch of invoices by unique property values
*SearchAPI* | [**PostCrmV3ObjectsInvoicesSearchDoSearch**](docs/SearchAPI.md#postcrmv3objectsinvoicessearchdosearch) | **Post** /crm/v3/objects/invoices/search | Search for invoices
...
```go
auth := context.WithValue(context.Background(), invoices.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, invoices.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		invoices.ContextAPIKeys,
		map[string]invoices.APIKey{
