...
type PublicOwner struct {
	...
	Id string `json:"id"`
	UserIdIncludingInactive *int32 `json:"userIdIncludingInactive,omitempty"`
...
// GetUserIdIncludingInactive returns the UserIdIncludingInactive field value if set, zero value otherwise.
func (o *PublicOwner) GetUserIdIncludingInactive() int32 {
	if o == nil || IsNil(o.UserIdIncludingInactive) {
		var ret int32
		return ret
	}
	return *o.UserIdIncludingInactive
}

// GetUserIdIncludingInactiveOk returns a tuple with the UserIdIncludingInactive field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PublicOwner) GetUserIdIncludingInactiveOk() (*int32, bool) {
	if o == nil || IsNil(o.UserIdIncludingInactive) {
		return nil, false
	}
	return o.UserIdIncludingInactive, true
}
...
// SetUserIdIncludingInactive gets a reference to the given int32 and assigns it to the UserIdIncludingInactive field.
func (o *PublicOwner) SetUserIdIncludingInactive(v int32) {
	o.UserIdIncludingInactive = &v
}
...
func (o PublicOwner) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["id"] = o.Id
	if !IsNil(o.UserIdIncludingInactive) {
		toSerialize["userIdIncludingInactive"] = o.UserIdIncludingInactive
	}
