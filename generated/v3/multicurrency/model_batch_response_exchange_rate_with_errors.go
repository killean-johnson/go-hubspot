...
// checks if the BatchResponseExchangeRateWithErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchResponseExchangeRateWithErrors{}

// BatchResponseExchangeRateWithErrors struct for BatchResponseExchangeRateWithErrors
type BatchResponseExchangeRateWithErrors struct {
...
type _BatchResponseExchangeRateWithErrors BatchResponseExchangeRateWithErrors
...
func NewBatchResponseExchangeRateWithErrors(completedAt time.Time, startedAt time.Time, results []ExchangeRate, status string) *BatchResponseExchangeRateWithErrors {
	this := BatchResponseExchangeRateWithErrors{}
...
func (o BatchResponseExchangeRateWithErrors) MarshalJSON() ([]byte, error) {
...
func (o BatchResponseExchangeRateWithErrors) ToMap() (map[string]interface{}, error) {
...
func (o *BatchResponseExchangeRateWithErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchResponseExchangeRateWithErrors := _BatchResponseExchangeRateWithErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchResponseExchangeRateWithErrors)

	if err != nil {
		return err
	}

	*o = BatchResponseExchangeRateWithErrors(varBatchResponseExchangeRateWithErrors)

	return err
}

type NullableBatchResponseExchangeRateWithErrors struct {
	value *BatchResponseExchangeRateWithErrors
	isSet bool
}

func (v NullableBatchResponseExchangeRateWithErrors) Get() *BatchResponseExchangeRateWithErrors {
	return v.value
}

func (v *NullableBatchResponseExchangeRateWithErrors) Set(val *BatchResponseExchangeRateWithErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchResponseExchangeRateWithErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchResponseExchangeRateWithErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchResponseExchangeRateWithErrors(val *BatchResponseExchangeRateWithErrors) *NullableBatchResponseExchangeRateWithErrors {
	return &NullableBatchResponseExchangeRateWithErrors{value: val, isSet: true}
}

func (v NullableBatchResponseExchangeRateWithErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchResponseExchangeRateWithErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
