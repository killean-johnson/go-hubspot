...
// checks if the BatchResponseExchangeRate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchResponseExchangeRate{}

// BatchResponseExchangeRate struct for BatchResponseExchangeRate
...
type _BatchResponseExchangeRate BatchResponseExchangeRate
...
func NewBatchResponseExchangeRate(completedAt time.Time, startedAt time.Time, results []ExchangeRate, status string) *BatchResponseExchangeRate {
	this := BatchResponseExchangeRate{}
...
func (o BatchResponseExchangeRate) MarshalJSON() ([]byte, error) {
...
func (o BatchResponseExchangeRate) ToMap() (map[string]interface{}, error) {
...
func (o *BatchResponseExchangeRate) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchResponseExchangeRate := _BatchResponseExchangeRate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchResponseExchangeRate)

	if err != nil {
		return err
	}

	*o = BatchResponseExchangeRate(varBatchResponseExchangeRate)

	return err
}

type NullableBatchResponseExchangeRate struct {
	value *BatchResponseExchangeRate
	isSet bool
}

func (v NullableBatchResponseExchangeRate) Get() *BatchResponseExchangeRate {
	return v.value
}

func (v *NullableBatchResponseExchangeRate) Set(val *BatchResponseExchangeRate) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchResponseExchangeRate) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchResponseExchangeRate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchResponseExchangeRate(val *BatchResponseExchangeRate) *NullableBatchResponseExchangeRate {
	return &NullableBatchResponseExchangeRate{value: val, isSet: true}
}

func (v NullableBatchResponseExchangeRate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchResponseExchangeRate) UnmarshalJSON(src []byte) error {
	v.isSet = true
