...
```go
import postal_mail "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `postal_mail.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), postal_mail.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `postal_mail.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), postal_mail.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `postal_mail.ContextOperationServerIndices` and `postal_mail.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), postal_mail.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), postal_mail.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsPostalMailPostalMailIdArchive**](docs/BasicAPI.md#deletecrmv3objectspostalmailpostalmailidarchive) | **Delete** /crm/v3/objects/postal_mail/{postalMailId} | Archive
*BasicAPI* | [**GetCrmV3ObjectsPostalMailGetPage**](docs/BasicAPI.md#getcrmv3objectspostalmailgetpage) | **Get** /crm/v3/objects/postal_mail | List
*BasicAPI* | [**GetCrmV3ObjectsPostalMailPostalMailIdGetById**](docs/BasicAPI.md#getcrmv3objectspostalmailpostalmailidgetbyid) | **Get** /crm/v3/objects/postal_mail/{postalMailId} | Read
*BasicAPI* | [**PatchCrmV3ObjectsPostalMailPostalMailIdUpdate**](docs/BasicAPI.md#patchcrmv3objectspostalmailpostalmailidupdate) | **Patch** /crm/v3/objects/postal_mail/{postalMailId} | Update
*BasicAPI* | [**PostCrmV3ObjectsPostalMailCreate**](docs/BasicAPI.md#postcrmv3objectspostalmailcreate) | **Post** /crm/v3/objects/postal_mail | Create
*BatchAPI* | [**PostCrmV3ObjectsPostalMailBatchArchiveArchive**](docs/BatchAPI.md#postcrmv3objectspostalmailbatcharchivearchive) | **Post** /crm/v3/objects/postal_mail/batch/archive | Archive a batch of postal mail by ID
*BatchAPI* | [**PostCrmV3ObjectsPostalMailBatchCreateCreate**](docs/BatchAPI.md#postcrmv3objectspostalmailbatchcreatecreate) | **Post** /crm/v3/objects/postal_mail/batch/create | Create a batch of postal mail
*BatchAPI* | [**PostCrmV3ObjectsPostalMailBatchReadRead**](docs/BatchAPI.md#postcrmv3objectspostalmailbatchreadread) | **Post** /crm/v3/objects/postal_mail/batch/read | Read a batch of postal mail by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsPostalMailBatchUpdateUpdate**](docs/BatchAPI.md#postcrmv3objectspostalmailbatchupdateupdate) | **Post** /crm/v3/objects/postal_mail/batch/update | Update a batch of postal mail by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsPostalMailBatchUpsertUpsert**](docs/BatchAPI.md#postcrmv3objectspostalmailbatchupsertupsert) | **Post** /crm/v3/objects/postal_mail/batch/upsert | Create or update a batch of postal mail by unique property values
*SearchAPI* | [**PostCrmV3ObjectsPostalMailSearchDoSearch**](docs/SearchAPI.md#postcrmv3objectspostalmailsearchdosearch) | **Post** /crm/v3/objects/postal_mail/search | 
...
```go
auth := context.WithValue(context.Background(), postal_mail.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, postal_mail.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		postal_mail.ContextAPIKeys,
		map[string]postal_mail.APIKey{
