...
```go
import discounts "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `discounts.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), discounts.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `discounts.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), discounts.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `discounts.ContextOperationServerIndices` and `discounts.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), discounts.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), discounts.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsDiscountsDiscountId**](docs/BasicAPI.md#deletecrmv3objectsdiscountsdiscountid) | **Delete** /crm/v3/objects/discounts/{discountId} | Archive
*BasicAPI* | [**GetCrmV3ObjectsDiscounts**](docs/BasicAPI.md#getcrmv3objectsdiscounts) | **Get** /crm/v3/objects/discounts | List
*BasicAPI* | [**GetCrmV3ObjectsDiscountsDiscountId**](docs/BasicAPI.md#getcrmv3objectsdiscountsdiscountid) | **Get** /crm/v3/objects/discounts/{discountId} | Read
*BasicAPI* | [**PatchCrmV3ObjectsDiscountsDiscountId**](docs/BasicAPI.md#patchcrmv3objectsdiscountsdiscountid) | **Patch** /crm/v3/objects/discounts/{discountId} | Update
*BasicAPI* | [**PostCrmV3ObjectsDiscounts**](docs/BasicAPI.md#postcrmv3objectsdiscounts) | **Post** /crm/v3/objects/discounts | Create
*BatchAPI* | [**PostCrmV3ObjectsDiscountsBatchArchive**](docs/BatchAPI.md#postcrmv3objectsdiscountsbatcharchive) | **Post** /crm/v3/objects/discounts/batch/archive | Archive a batch of discounts by ID
*BatchAPI* | [**PostCrmV3ObjectsDiscountsBatchCreate**](docs/BatchAPI.md#postcrmv3objectsdiscountsbatchcreate) | **Post** /crm/v3/objects/discounts/batch/create | Create a batch of discounts
*BatchAPI* | [**PostCrmV3ObjectsDiscountsBatchRead**](docs/BatchAPI.md#postcrmv3objectsdiscountsbatchread) | **Post** /crm/v3/objects/discounts/batch/read | Read a batch of discounts by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsDiscountsBatchUpdate**](docs/BatchAPI.md#postcrmv3objectsdiscountsbatchupdate) | **Post** /crm/v3/objects/discounts/batch/update | Update a batch of discounts by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsDiscountsBatchUpsert**](docs/BatchAPI.md#postcrmv3objectsdiscountsbatchupsert) | **Post** /crm/v3/objects/discounts/batch/upsert | Create or update a batch of discounts by unique property values
*SearchAPI* | [**PostCrmV3ObjectsDiscountsSearch**](docs/SearchAPI.md#postcrmv3objectsdiscountssearch) | **Post** /crm/v3/objects/discounts/search | 
...
```go
auth := context.WithValue(context.Background(), discounts.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, discounts.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		discounts.ContextAPIKeys,
		map[string]discounts.APIKey{
