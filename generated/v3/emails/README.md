...
```go
import emails "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `emails.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), emails.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `emails.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), emails.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `emails.ContextOperationServerIndices` and `emails.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), emails.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), emails.ContextOperationServerVariables, map[string]map[string]string{
...
------------ | ------------- | ------------- | -------------
*BasicAPI* | [**DeleteCrmV3ObjectsEmailsEmailIdArchive**](docs/BasicAPI.md#deletecrmv3objectsemailsemailidarchive) | **Delete** /crm/v3/objects/emails/{emailId} | Archive
*BasicAPI* | [**GetCrmV3ObjectsEmailsEmailIdGetById**](docs/BasicAPI.md#getcrmv3objectsemailsemailidgetbyid) | **Get** /crm/v3/objects/emails/{emailId} | Read
*BasicAPI* | [**GetCrmV3ObjectsEmailsGetPage**](docs/BasicAPI.md#getcrmv3objectsemailsgetpage) | **Get** /crm/v3/objects/emails | List
*BasicAPI* | [**PatchCrmV3ObjectsEmailsEmailIdUpdate**](docs/BasicAPI.md#patchcrmv3objectsemailsemailidupdate) | **Patch** /crm/v3/objects/emails/{emailId} | Update
*BasicAPI* | [**PostCrmV3ObjectsEmailsCreate**](docs/BasicAPI.md#postcrmv3objectsemailscreate) | **Post** /crm/v3/objects/emails | Create
*BatchAPI* | [**PostCrmV3ObjectsEmailsBatchArchiveArchive**](docs/BatchAPI.md#postcrmv3objectsemailsbatcharchivearchive) | **Post** /crm/v3/objects/emails/batch/archive | Archive a batch of emails by ID
*BatchAPI* | [**PostCrmV3ObjectsEmailsBatchCreateCreate**](docs/BatchAPI.md#postcrmv3objectsemailsbatchcreatecreate) | **Post** /crm/v3/objects/emails/batch/create | Create a batch of emails
*BatchAPI* | [**PostCrmV3ObjectsEmailsBatchReadRead**](docs/BatchAPI.md#postcrmv3objectsemailsbatchreadread) | **Post** /crm/v3/objects/emails/batch/read | Read a batch of emails by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsEmailsBatchUpdateUpdate**](docs/BatchAPI.md#postcrmv3objectsemailsbatchupdateupdate) | **Post** /crm/v3/objects/emails/batch/update | Update a batch of emails by internal ID, or unique property values
*BatchAPI* | [**PostCrmV3ObjectsEmailsBatchUpsertUpsert**](docs/BatchAPI.md#postcrmv3objectsemailsbatchupsertupsert) | **Post** /crm/v3/objects/emails/batch/upsert | Create or update a batch of emails by unique property values
*SearchAPI* | [**PostCrmV3ObjectsEmailsSearchDoSearch**](docs/SearchAPI.md#postcrmv3objectsemailssearchdosearch) | **Post** /crm/v3/objects/emails/search | 
...
```go
auth := context.WithValue(context.Background(), emails.ContextAccessToken, "ACCESSTOKENSTRING")
...
auth := context.WithValue(oauth2.NoContext, emails.ContextOAuth2, tokenSource)
r, err := client.Service.Operation(auth, args)
```
...
auth := context.WithValue(
		context.Background(),
		emails.ContextAPIKeys,
		map[string]emails.APIKey{
